advancement revoke @s only blue:tr/tasks/bolt req
...
execute unless score #.tr.random_task_defender blue.config matches 0 if entity @s[tag=!blue.tr.rtd_cooldown,predicate=blue:r/10c] run function blue:tr/tasks/rtd/bolt