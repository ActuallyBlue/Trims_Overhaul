...
execute unless score #.tr.random_task_defender blue.config matches 0 if entity @s[tag=!blue.tr.rtd_cooldown,predicate=blue:r/03c,scores={blue.tr.combat=0..}] run function blue:tr/tasks/rtd/dune