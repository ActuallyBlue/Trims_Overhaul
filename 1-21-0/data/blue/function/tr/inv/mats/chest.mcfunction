...
execute if data storage blue:trims armor.chest{material:"minecraft:redstone"} run return run attribute @s generic.max_health modifier add blue:tr.chest 1.0 add_value
...
execute if data storage blue:trims armor.chest{material:"minecraft:lapis"} run return run attribute @s generic.movement_speed modifier add blue:tr.chest 0.003 add_value
...
execute if data storage blue:trims armor.chest{material:"minecraft:gold"} run return run attribute @s generic.attack_speed modifier add blue:tr.chest 0.04 add_value
