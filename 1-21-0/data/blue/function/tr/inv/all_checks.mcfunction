...
data modify storage blue:trims armor.head set from storage blue:trims inventory[{Slot:3b}].components."minecraft:trim"
data modify storage blue:trims armor.chest set from storage blue:trims inventory[{Slot:2b}].components."minecraft:trim"
data modify storage blue:trims armor.legs set from storage blue:trims inventory[{Slot:1b}].components."minecraft:trim"
data modify storage blue:trims armor.feet set from storage blue:trims inventory[{Slot:0b}].components."minecraft:trim"
