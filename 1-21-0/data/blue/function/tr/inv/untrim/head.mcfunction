...
data modify storage blue:trims temp.args set value '_armor_trim_smithing_template"} ~ ~ ~ 0.22 0.22 0.22 0.02 10'
execute if data storage blue:trims temp{trim:"dragon_egg"} run data modify storage blue:trims temp.args set value '"} ~ ~ ~ 0.22 0.22 0.22 0.02 10'
