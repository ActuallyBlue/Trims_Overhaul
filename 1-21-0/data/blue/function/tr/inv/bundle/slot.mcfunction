...
data modify storage blue:data trims.temp.bundle set from block 200600 2 200600 Items[{Slot:0b}].components.minecraft:bundle_contents[{components:{"minecraft:trim":{}}}]
function blue:tr/inv/bundle/spawn with storage blue:data trims.temp.bundle
