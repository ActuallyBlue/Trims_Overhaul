...
execute if items entity @s contents *[trim~{pattern:bolt}] as @e[type=item,distance=..3,tag=!blue.tr.checked] if items entity @s contents *[trim~{pattern:bolt}] run function blue:tr/inv/died/extra
execute if items entity @s contents *[trim~{pattern:flow}] as @e[type=item,distance=..3,tag=!blue.tr.checked] if items entity @s contents *[trim~{pattern:flow}] run function blue:tr/inv/died/extra
