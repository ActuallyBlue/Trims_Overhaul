...
execute unless items entity @s contents *[trim~{pattern:flow}] unless items entity @s contents flow_armor_trim_smithing_template run scoreboard players set #.temp blue.misc 18
execute unless score #.temp blue.misc matches 18 as @e[distance=..3,tag=!blue.tr.checked,type=item] if items entity @s contents flow_armor_trim_smithing_template run function blue:tr/inv/died/extra
execute unless score #.temp blue.misc matches 18 as @e[distance=..3,tag=!blue.tr.checked,type=item] if items entity @s contents *[trim~{pattern:flow}] run function blue:tr/inv/died/extra
execute unless items entity @s contents *[trim~{pattern:bolt}] unless items entity @s contents bolt_armor_trim_smithing_template run scoreboard players set #.temp blue.misc 17
execute unless score #.temp blue.misc matches 17 as @e[distance=..3,tag=!blue.tr.checked,type=item] if items entity @s contents bolt_armor_trim_smithing_template run function blue:tr/inv/died/extra
execute unless score #.temp blue.misc matches 17 as @e[distance=..3,tag=!blue.tr.checked,type=item] if items entity @s contents *[trim~{pattern:bolt}] run function blue:tr/inv/died/extra
