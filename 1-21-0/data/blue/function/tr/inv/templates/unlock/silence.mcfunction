...
execute if score #.tr.silence_completed blue.config matches 0 if function blue:tr/inv/templates/unlock/is_limit if entity @s[advancements={blue:tr/blacklist={silence=false}}] run function blue:tr/completion/silence
