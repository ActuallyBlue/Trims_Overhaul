...
execute if score #.tr.shaper_completed blue.config matches 0 if function blue:tr/inv/templates/unlock/is_limit if entity @s[advancements={blue:tr/blacklist={shaper=false}}] run function blue:tr/completion/shaper
