...
execute if score #.tr.spire_completed blue.config matches 0 if function blue:tr/inv/templates/unlock/is_limit if entity @s[advancements={blue:tr/blacklist={spire=false}}] run function blue:tr/completion/spire
