...
$execute if entity @s[tag=blue.tr.transfer_target] run return run tellraw @s [{"text":"- ","color":"dark_gray"},{"translate":"blue.tr.given_ownership","fallback":"You've been given ownership over ","color":"gray"},{"translate":"$(translate)","color":"$(color)"}," ",{"text":"ℹ","hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.info_shortcut","fallback":"Click here for a shortcut to the info menu","color":"gray"}},"hover_event":{"action":"show_text","value":{"translate":"blue.tr.info_shortcut","fallback":"Click here for a shortcut to the info menu","color":"gray"}},"clickEvent":{"action":"run_command","value":"/trigger Trims_Menu.BLUE set 50"},"click_event":{"action":"run_command","command":"/trigger Trims_Menu.BLUE set 50"},"color":"gray"}]
...
$tellraw @s [{"text":"- ","color":"dark_gray"},{"translate":"blue.tr.stolen_ownership","fallback":"You've stolen ownership over ","color":"gray"},{"translate":"$(translate)","color":"$(color)"}," ",{"text":"ℹ","hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.info_shortcut","fallback":"Click here for a shortcut to the info menu","color":"gray"}},"hover_event":{"action":"show_text","value":{"translate":"blue.tr.info_shortcut","fallback":"Click here for a shortcut to the info menu","color":"gray"}},"clickEvent":{"action":"run_command","value":"/trigger Trims_Menu.BLUE set 50"},"click_event":{"action":"run_command","command":"/trigger Trims_Menu.BLUE set 50"},"color":"gray"}]