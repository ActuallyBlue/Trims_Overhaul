...
execute anchored eyes rotated ~ 0 unless block ^ ^ ^1 smithing_table unless block ^ ^ ^2 smithing_table if block ^ ^ ^3 smithing_table run fill ^ ^ ^3 ^ ^ ^3 air destroy
execute anchored eyes rotated ~ 0 unless block ^ ^ ^1 smithing_table if block ^ ^ ^2 smithing_table run fill ^ ^ ^2 ^ ^ ^2 air destroy
execute anchored eyes rotated ~ 0 if block ^ ^ ^1 smithing_table run fill ^ ^ ^1 ^ ^ ^1 air destroy
...
execute positioned ~ ~1.7 ~ run function blue:tr/inv/transfer/untrim_head with storage blue:trims inventory[{Slot:3b}].components."minecraft:trim"
execute positioned ~ ~1.25 ~ run function blue:tr/inv/transfer/untrim_chest with storage blue:trims inventory[{Slot:2b}].components."minecraft:trim"
execute positioned ~ ~0.75 ~ run function blue:tr/inv/transfer/untrim_legs with storage blue:trims inventory[{Slot:1b}].components."minecraft:trim"
execute positioned ~ ~0.25 ~ run function blue:tr/inv/transfer/untrim_feet with storage blue:trims inventory[{Slot:0b}].components."minecraft:trim"
