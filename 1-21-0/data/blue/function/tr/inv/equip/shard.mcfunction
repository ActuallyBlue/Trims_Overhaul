execute at @s[advancements={blue:tr/actual/shard=false},tag=!blue.tr.ignore_first] run function blue:tr/inv/equip/first/shard
...
advancement grant @s only blue:tr/actual/shard
