...
execute if score #.tr.flow_completed blue.config matches 1.. run advancement grant @s only blue:tr/actual/flow
execute if score #.tr.bolt_completed blue.config matches 1.. run advancement grant @s only blue:tr/actual/bolt
