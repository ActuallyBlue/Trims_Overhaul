...
execute if score #.temp blue.misc matches 15..29 run data modify storage blue:data trims.display append value [{"translate":"blue.tr.were_changed","fallback":" were changed.","color":"gray"}]
execute if score #.temp blue.misc matches 15..29 run tellraw @s [{"text":"","underlined":true,"hover_event":{"action":"show_text","value":{"storage":"blue:data","nbt":"trims.display[]","separator":{"text":". ","color":"black"},"interpret":true}},"hoverEvent":{"action":"show_text","contents":{"storage":"blue:data","nbt":"trims.display[]","separator":{"text":". ","color":"black"},"interpret":true}}},{"score":{"name":"#.temp","objective":"blue.misc"}},{"translate":"blue.tr.settings_short","fallback":" Settings were changed.","color":"gray"}]
execute if score #.temp blue.misc matches 30.. run data modify storage blue:data trims.display set value [{"text":"- ","color":"dark_gray"},{"translate":"blue.tr.all_changed","fallback":"All settings were changed","color":"gray"}]
execute unless score #.temp blue.misc matches 15..29 run tellraw @s {"storage":"blue:data","nbt":"trims.display","interpret":true}
