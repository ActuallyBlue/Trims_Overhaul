...
execute positioned ^ ^ ^1 positioned ~-1.5 ~-1.5 ~-1.5 as @e[type=!#blue:shared/no_effects,tag=!smithed.strict,type=!player,dx=2,dy=2,dz=2] positioned as @s run function blue:tr/effects/ward/kinetic/barrier/shootfacing
