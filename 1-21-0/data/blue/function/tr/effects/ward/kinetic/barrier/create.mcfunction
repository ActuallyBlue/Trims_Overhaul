...
tp @e[tag=blue.tr.ward_barrier,distance=..5,type=block_display] ^ ^ ^1 ~ ~
execute as @e[tag=blue.tr.ward_barrier,type=block_display] run ride @s mount b163102f-0-a-0-1
