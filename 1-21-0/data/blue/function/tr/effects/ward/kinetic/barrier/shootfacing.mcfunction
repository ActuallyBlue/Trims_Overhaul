execute if entity @s[tag=!blue.tr.item_projectile,type=item] run return fail
execute if entity @s[type=#arrows,nbt={inBlockState:{}}] run return fail
execute if entity @s[tag=!blue.tr.shaper.tnt,type=tnt] run return fail
tag @s[type=#blue:tr/barrier_deflectable] add blue.tr.ward.deflected
