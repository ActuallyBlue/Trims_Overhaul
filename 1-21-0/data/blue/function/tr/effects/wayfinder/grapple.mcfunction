...
particle enchant
execute if block ~ ~-0.5 ~ #blue:trims/passable if block ~0.5 ~ ~ #blue:trims/passable if block ~-0.5 ~ ~ #blue:trims/passable if block ~ ~ ~0.5 #blue:trims/passable if block ~ ~ ~-0.5 #blue:trims/passable if block ~ ~0.5 ~ #blue:trims/passable if block ~ ~0.5 ~ #blue:trims/passable run return fail
