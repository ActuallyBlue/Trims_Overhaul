...
execute summon marker unless function blue:shared/kill run data modify storage blue:trims locator.Pos set from entity @s Pos
execute store result score #.nearX blue.misc run data get storage blue:trims locator.Pos[0]
execute store result score #.nearY blue.misc run data get storage blue:trims locator.Pos[1]
execute store result score #.nearZ blue.misc run data get storage blue:trims locator.Pos[2]
