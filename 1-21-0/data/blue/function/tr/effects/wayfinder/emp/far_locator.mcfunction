...
execute store result score #.farX blue.misc run data get storage blue:trims locator.Pos[0]
execute store result score #.farY blue.misc run data get storage blue:trims locator.Pos[1]
execute store result score #.farZ blue.misc run data get storage blue:trims locator.Pos[2]
