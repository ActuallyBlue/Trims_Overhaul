...
execute summon marker unless function blue:shared/kill run data modify storage blue:data trims.locator.Pos set from entity @s Pos
execute store result score #.farX blue.misc run data get storage blue:data trims.locator.Pos[0]
execute store result score #.farY blue.misc run data get storage blue:data trims.locator.Pos[1]
execute store result score #.farZ blue.misc run data get storage blue:data trims.locator.Pos[2]
