...
execute store result storage blue:trims temp.warp.Pos[0] double 1 run data get storage blue:trims temp.warp.pos[0]
execute store result storage blue:trims temp.warp.Pos[1] double 1 run data get storage blue:trims temp.warp.pos[1]
execute store result storage blue:trims temp.warp.Pos[2] double 1 run data get storage blue:trims temp.warp.pos[2]
execute if data storage blue:trims temp.warp{dimension:"minecraft:overworld"} in overworld summon marker run function blue:tr/effects/wayfinder/emp/warp/marker
execute if data storage blue:trims temp.warp{dimension:"minecraft:the_end"} in the_end summon marker run function blue:tr/effects/wayfinder/emp/warp/marker
execute if data storage blue:trims temp.warp{dimension:"minecraft:the_nether"} in the_nether summon marker run function blue:tr/effects/wayfinder/emp/warp/marker
