...
execute unless score #.wayfinder.sprint blue.misc matches 20.. run return fail
execute unless predicate blue:shared/is_sprinting run effect clear @s speed
execute unless predicate {"condition":"entity_properties","entity":"this","predicate":{"effects":{"minecraft:speed":{"amplifier":{"min":6}}}}} run return fail
