...
execute if score @s blue.tr.combat matches -300.. unless entity @s[predicate=!blue:tr/explorer,predicate=!blue:tr/hold_spear] run function blue:tr/effects/wayfinder/bonus
