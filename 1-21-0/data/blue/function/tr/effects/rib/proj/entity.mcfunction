...
summon area_effect_cloud ~ ~ ~ {Rotation:[0,180],Radius:0,Tags:["blue.tr.rib.skull"],Duration:25,custom_particle:{type:"minecraft:block",block_state:"minecraft:air"},Particle:{type:"minecraft:block",block_state:"minecraft:air"}}
