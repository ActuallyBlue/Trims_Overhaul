...
summon small_fireball ^ ^ ^2 {UUID:[I;-1318907857,12,0,1],acceleration_power:0.0225d}
...
execute if predicate {"condition":"location_check","predicate":{"structures":"fortress"}} run schedule function blue:tr/effects/rib/proj/cooldown 70t
