...
execute as @n[type=#blue:shared/projectiles,tag=!blue.tr.rib.checked,distance=..5] at @s run function blue:tr/effects/rib/emp/aegis_burn
...
execute as @e[type=!#blue:shared/peaceful,type=!player,distance=..4.5,team=!blue.tr.rib] run damage @s 6 blue:tr/fire by @a[tag=blue.tr.rib,limit=1]
