...
execute positioned ~ ~-1.25 ~ align xyz if entity @e[type=marker,tag=blue.tr.wild.trap,dx=0,limit=1] run return run function blue:tr/effects/wild/emp/no_place
