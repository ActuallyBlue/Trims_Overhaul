...
scoreboard players remove #.hPos blue.misc 1
...
execute unless block ~ ~ ~ #blue:trims/passable unless block ~ ~ ~ #blue:trims/copper run scoreboard players add #.zap_steps blue.misc 4
