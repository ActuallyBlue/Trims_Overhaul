...
scoreboard players remove #.bolt.horizontal blue.misc 1
...
execute unless block ~ ~ ~ #blue:shared/passable unless block ~ ~ ~ #blue:shared/copper_blocks run scoreboard players add #.bolt.zap_steps blue.misc 4
scoreboard players add #.bolt.zap_steps blue.misc 1
execute if score #.bolt.zap_steps blue.misc matches 80.. at @s run return run function blue:tr/effects/bolt/conduct/user
