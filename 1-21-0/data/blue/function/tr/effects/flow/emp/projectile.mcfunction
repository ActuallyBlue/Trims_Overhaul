...
data modify storage blue:trims flow.m set from entity @s Motion
...
execute if score #.flow.barrage_time blue.misc matches 1.. run function blue:tr/effects/flow/emp/barrage/deflect
