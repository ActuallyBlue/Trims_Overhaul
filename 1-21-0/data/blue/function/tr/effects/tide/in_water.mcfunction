execute unless items entity @s armor.feet *[enchantments~[{enchantments:depth_strider}]] run effect give @s dolphins_grace 1 0 true
...
execute unless score #.tide.ambient_water blue.misc matches 3.. run return fail
