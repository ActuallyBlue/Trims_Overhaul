...
execute if entity @s[x_rotation=-90..-75] if predicate blue:shared/on_ground unless score #.spire.reversal_charge blue.misc matches ..-1 rotated 0 0 run function blue:tr/effects/spire/emp/reversal/charge
execute if score #.spire.reversal_charge blue.misc matches 0.. unless predicate blue:shared/on_ground run function blue:tr/effects/spire/emp/reversal/release
