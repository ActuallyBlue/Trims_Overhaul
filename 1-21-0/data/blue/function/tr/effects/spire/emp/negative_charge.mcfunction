...
execute unless score #.spire.reversal_charge blue.misc matches ..-600 run return fail
...
summon area_effect_cloud ~ ~ ~ {Rotation:[0,180],Tags:["blue.tr.plunge_aec"],custom_particle:{type:"witch"},Particle:{type:"witch"},Duration:31,Radius:3,RadiusPerTick:0.5,WaitTime:0s}
