...
execute if score #.OnGround blue.misc matches 0 run return fail
...
summon area_effect_cloud ~ ~ ~ {Tags:["blue.tr.plunge_aec"],custom_particle:{type:"witch"},Particle:{type:"witch"},Duration:30,Radius:3,RadiusPerTick:0.5}
