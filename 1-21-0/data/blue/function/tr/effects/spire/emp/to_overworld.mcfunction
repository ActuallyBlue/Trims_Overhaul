...
execute if score #.spire.aperture blue.config matches 2 run return fail
execute if entity b163102f-0-2-0-1 run return fail
forceload add ~ ~
...
scoreboard players set #.spire.aperture_sound blue.misc 20
...
execute at b163102f-0-2-0-1 in the_end run summon lightning_bolt ~ ~-16 ~