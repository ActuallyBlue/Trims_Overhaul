...
execute if score #.temp blue.misc matches 1 facing entity @s feet run particle end_rod ^ ^0.4 ^ ^ ^ ^-100000 0.000003 0 normal @a[scores={blue.particles=1..}]
execute if score #.temp blue.misc matches 0 facing entity @s feet run particle end_rod ^ ^0.4 ^ ^ ^ ^-100000 0.000003 0
