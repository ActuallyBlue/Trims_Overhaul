...
execute if score #.spire.last_reversal_charge blue.misc matches 55.. run return run scoreboard players set #.spire.reversal_charge blue.misc -1000
schedule function blue:tr/effects/spire/guidance_cooldown 70t
scoreboard players set #.spire.reversal_charge blue.misc -340