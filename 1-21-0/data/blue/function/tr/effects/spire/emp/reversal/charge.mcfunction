...
execute if score #.reversal_charge blue.misc matches 55.. run effect give @s slowness 1 4 true
...
execute unless score #.reversal_charge blue.misc matches 70 run return fail
