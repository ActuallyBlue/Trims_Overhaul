...
summon piglin_brute ~4 ~ ~ {Tags:["blue.tr.gamble.punisher"],HandItems:[{id:golden_axe},{id:golden_axe}],equipment:{mainhand:{id:golden_axe},offhand:{id:golden_axe}},DeathLootTable:""}
summon piglin_brute ~-4 ~ ~ {Tags:["blue.tr.gamble.punisher"],HandItems:[{id:golden_axe},{id:golden_axe}],equipment:{mainhand:{id:golden_axe},offhand:{id:golden_axe}},DeathLootTable:""}
