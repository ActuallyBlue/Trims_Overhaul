...
execute as @e[type=!#blue:shared/no_ai,type=!player,distance=..16,tag=!smithed.strict] at @e[type=marker,tag=blue.tr.gamble.scramble,distance=..40,sort=random,limit=1] run function blue:tr/effects/snout/gamble/scrambled
