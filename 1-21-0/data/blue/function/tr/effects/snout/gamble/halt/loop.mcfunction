...
execute at @e[type=area_effect_cloud,tag=blue.tr.mob_freeze] as @n[type=!#blue:shared/no_ai,type=!player,tag=!smithed.strict,distance=..1] run function blue:tr/effects/snout/gamble/halt/mob
