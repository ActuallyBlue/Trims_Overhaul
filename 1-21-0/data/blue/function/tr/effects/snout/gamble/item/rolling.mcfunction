...
execute if score #.snout.withdrawal blue.misc matches 1.. if predicate {"condition":"random_chance","chance":0.6} run scoreboard players remove @s[scores={blue.misc=..49}] blue.misc 1
