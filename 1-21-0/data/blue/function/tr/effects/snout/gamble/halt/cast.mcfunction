...
execute as @a[gamemode=!spectator,gamemode=!creative,tag=!blue.tr.snout,distance=..16] at @s run function blue:tr/effects/snout/gamble/halt/freeze
...
summon area_effect_cloud ~ ~ ~ {Rotation:[0,180],Radius:0,Duration:400,Tags:["blue.tr.snout.center"],custom_particle:{type:"minecraft:block",block_state:"minecraft:air"},Particle:{type:"minecraft:block",block_state:"minecraft:air"}}
