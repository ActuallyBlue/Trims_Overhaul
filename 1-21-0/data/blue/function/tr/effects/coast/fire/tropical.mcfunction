...
data merge entity @s {Tags:["blue.tr.coast.projectile","blue.tr.coast.tropical","smithed.entity"],teleport_duration:1,item:{id:tropical_fish},transformation:{scale:[0.5f,0.5f,0.5f],left_rotation:[-0.28f,-0.65f,0.28f,0.65f]}}
...
execute unless predicate blue:r/10c run return fail
item replace entity @s contents with tropical_fish[enchantment_glint_override=true]
playsound entity.fish.swim player @a ~ ~ ~ 0.5 2
tag @s add blue.tr.coast.reverse