...
execute if score #.coast.double_shot blue.misc matches 1 unless score #.coast.shot_delay blue.misc matches 12.. run return fail
execute if score #.coast.double_shot blue.misc matches 2 unless score #.coast.shot_delay blue.misc matches 15.. run return fail
execute if score #.coast.double_shot blue.misc matches 3 unless score #.coast.shot_delay blue.misc matches 18.. run return fail
