...
execute unless block ~ ~ ~ #fall_damage_resetting unless block ~ ~ ~ water unless score @s[predicate=blue:shared/on_ground] blue.tr.died matches 1.. run function blue:tr/effects/shaper/emp/impact