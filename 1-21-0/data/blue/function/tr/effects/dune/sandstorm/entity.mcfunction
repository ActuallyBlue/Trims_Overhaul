...
execute as @e[type=ender_pearl,distance=..9] at @s on origin if entity @s[advancements={blue:tr/trust={dune=true}}] run data merge entity @e[type=ender_pearl,distance=..0.01,limit=1] {Item:{id:"minecraft:birch_button",custom_model_data:200600,components:{"minecraft:item_model":"air"}},Tags:["blue.tr.dune_thrown"]}
