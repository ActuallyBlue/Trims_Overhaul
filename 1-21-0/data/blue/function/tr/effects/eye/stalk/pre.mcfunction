...
execute if score #.eye.scare_cooldown blue.misc matches 1 run return run title @s actionbar {"text":"##########","color":"dark_green","italic":true,"obfuscated":true}
execute unless score #.eye.scare_charge blue.misc matches 19.. run return run title @s actionbar {"text":"👁👁👁👁👁👁👁👁👁👁","color":"dark_green","italic":true}
