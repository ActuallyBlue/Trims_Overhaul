...
execute as @a[scores={blue.tr.used_pearl=1..}] run function blue:tr/effects/eye/emp/disfigure/curse
...
execute if score #.eye.two_tick blue.misc matches 1 if items entity @s weapon.* ender_eye positioned ^ ^ ^5 as @p[distance=..16,tag=!blue.tr.eye,gamemode=!spectator] run function blue:tr/effects/eye/emp/display
execute if score #.eye.view_fear blue.misc matches 0 run title @s actionbar ""
execute as @e[tag=!blue.tr.checked,distance=..6,type=eye_of_ender] run function blue:tr/effects/eye/emp/disfigure/track_eye
...
execute unless score #.eye.disfigure_time blue.misc matches 1.. run return run execute unless score #.20 blue.misc matches 2..10 unless score #.20 blue.misc matches 12.. anchored eyes positioned ^ ^ ^2.5 run function blue:tr/effects/eye/emp/disfigure/cast
