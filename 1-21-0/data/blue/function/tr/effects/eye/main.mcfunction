...
execute as @e[type=eye_of_ender,tag=!blue.tr.eye_checked,distance=..6] run function blue:tr/effects/eye/emp/disconfigure/track_eye
...
execute unless score #.eye.disconfigure_time blue.misc matches 1.. unless score #.20 blue.misc matches 2..10 unless score #.20 blue.misc matches 12.. anchored eyes positioned ^ ^ ^2.5 run function blue:tr/effects/eye/emp/disconfigure/cast
execute unless score #.eye.disconfigure_time blue.misc matches 1.. run return fail
scoreboard players remove #.eye.disconfigure_time blue.misc 1
...
execute anchored eyes positioned ^ ^ ^2.5 run function blue:tr/effects/eye/emp/disconfigure/cast