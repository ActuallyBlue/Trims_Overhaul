...
execute if score @s blue.tr.fear > #.eye.disconfigure_time blue.config run function blue:tr/effects/eye/emp/disconfigure/explode
schedule function blue:tr/effects/eye/emp/disconfigure/remove 6t
scoreboard players set #.eye.disconfigure_time blue.misc 7