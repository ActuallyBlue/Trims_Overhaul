...
execute if score #.temp blue.misc matches 45..46 run return run tp @s @s
execute if score #.temp blue.misc matches 47..48 run return run function blue:tr/effects/eye/emp/fear/damage
execute if score #.temp blue.misc matches 49..50 run return run effect give @s blindness 5 0
execute if score #.temp blue.misc matches 51..52 run return run function blue:tr/effects/eye/emp/fear/float_medium
execute if score #.temp blue.misc matches 53 run return run tp @s ~ ~ ~ facing entity @e[sort=random,limit=1,distance=..32]
execute if score #.temp blue.misc matches 54 run return run function blue:tr/effects/eye/emp/fear/float_strong
execute if score #.temp blue.misc matches 55 run return run playsound item.totem.use player @s ~ ~ ~ 0.9 1
execute if score #.temp blue.misc matches 56 run return run effect give @s slowness 2 100
