...
execute if entity @s[tag=blue.tr.eye] run return fail
execute at b163102f-0-1-0-1 unless entity @s[distance=..300] run return fail
execute store success score #.temp blue.misc if predicate blue:tr/in_stronghold
