...
execute if entity @s[tag=!blue.tr.eye,gamemode=!spectator,gamemode=!creative] run function blue:tr/effects/eye/alarm/positioned with storage blue:trims eye
