...
execute if score #.temp blue.misc matches 160.. store success score #.temp blue.misc run attribute @s[advancements={blue:tr/cure={7=true}}] generic.max_health modifier add blue:tr.trim 15.2 add_value
execute if score #.temp blue.misc matches 140.. store success score #.temp blue.misc run attribute @s[advancements={blue:tr/cure={6=true}}] generic.max_health modifier add blue:tr.trim 12.6 add_value
