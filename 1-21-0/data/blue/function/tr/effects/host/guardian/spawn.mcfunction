...
execute if score #.temp blue.misc matches 1 unless entity @e[distance=..32,limit=1,type=iron_golem] run summon iron_golem ^ ^ ^-0.5 {UUID:[I;-1318907857,17,0,1],Tags:["blue.tr.host.morale","blue.tr.host.guardian"],active_effects:[{id:"glowing",duration:100},{id:"fire_resistance",duration:1200,amplifier:2},{id:"resistance",duration:1200,amplifier:1},{id:"speed",duration:1200},{id:"weakness",duration:1200,amplifier:1}],DeathLootTable:""}
execute if score #.temp blue.misc matches 0 unless entity @e[distance=..32,limit=1,type=iron_golem] run summon iron_golem ^ ^ ^-0.5 {UUID:[I;-1318907857,17,0,1],Tags:["blue.tr.host.morale","blue.tr.host.guardian"],DeathLootTable:""}
