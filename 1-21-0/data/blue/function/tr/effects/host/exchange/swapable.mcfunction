...
execute if score #.exchange_channel blue.misc matches 5.. run particle dust{color:[0.9f,0.9f,0.8f],scale:1} ~ ~0.7 ~ 0.35 0.5 0.35 0 6 force @a[tag=blue.tr.host]
...
execute at @a[tag=blue.tr.host,limit=1] run tp ~ ~ ~