...
execute anchored eyes run summon item ^ ^ ^1 {Invulnerable:1b,UUID:[I;-1318907857,15,0,1],Age:5600s,PickupDelay:32767s,Item:{id:"minecraft:sculk"},Tags:["blue.tr.checked","blue.tr.silence.vortex","smithed.entity","blue.tr.item_projectile"],Motion:[0d,0d,0d]}
