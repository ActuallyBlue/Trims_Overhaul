...
execute if score #.sentry.range blue.misc matches 125 if predicate {condition:"entity_properties",entity:"this",predicate:{effects:{"hero_of_the_village":{amplifier:1}}}} run scoreboard players set #.sentry.range blue.misc 150
execute if score #.sentry.range blue.misc matches 125 if predicate {condition:"entity_properties",entity:"this",predicate:{effects:{"hero_of_the_village":{amplifier:2}}}} run scoreboard players set #.sentry.range blue.misc 175
execute if score #.sentry.range blue.misc matches 125 if predicate {condition:"entity_properties",entity:"this",predicate:{effects:{"hero_of_the_village":{amplifier:3}}}} run scoreboard players set #.sentry.range blue.misc 200
execute if score #.sentry.range blue.misc matches 125 if predicate {condition:"entity_properties",entity:"this",predicate:{effects:{"hero_of_the_village":{amplifier:{min:4}}}}} run scoreboard players set #.sentry.range blue.misc 225
