...
execute on origin if score @s blue.tr.current_trim matches 7 run function blue:tr/effects/sentry/owner
...
execute if score #.temp blue.misc matches -54 run return run data modify entity @s crit set value 1b
