...
summon area_effect_cloud ~ ~1 ~ {UUID:[I;-1318907857,16,0,1],Tags:["blue.tr.sentry.refresh_cloud"],Duration:99,DurationOnUse:-99,Radius:3,WaitTime:0,custom_particle:{type:"block",block_state:"air"},Particle:{type:"block",block_state:"air"}}
