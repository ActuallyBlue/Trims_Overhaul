execute if data storage blue:data shared run data modify storage blue:shared {} merge from storage blue:data shared
execute if data storage blue:data shared run data remove storage blue:data shared
execute if data storage blue:data trims run data modify storage blue:trims {} merge from storage blue:data trims
execute if data storage blue:data trims run data remove storage blue:data trims
execute if data storage blue:trims telemetry run function blue:tr/debug/logs/z/upd
execute if data storage blue:shared names run scoreboard players reset * blue.id
data remove storage blue:shared names
data remove storage blue:shared UUID
data remove storage blue:trims unlock_text.italic
...
execute unless score #.tr.sentry_quest blue.config matches 0.. run scoreboard players set #.tr.sentry_quest blue.config 8
...
execute unless score #.tr.rib_quest_target blue.config matches 0.. run scoreboard players set #.tr.rib_quest_target blue.config 1
