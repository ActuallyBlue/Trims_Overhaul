...
execute if score #.TrimsOverhaul blue.misc = #.TrimsOverhaul blue.misc run tellraw @a ["",{"translate":"blue.tr.trims_overhaul","fallback":"Trims Overhaul","underlined":true,"color":"#3aa56a","clickEvent":{"action":"open_url","value":"https://modrinth.com/datapack/trims-overhaul"},"click_event":{"action":"open_url","url":"https://modrinth.com/datapack/trims-overhaul"},"hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.open_modrinth","fallback":"Opens the official Modrinth page","color":"gray"}},"hover_event":{"action":"show_text","value":{"translate":"blue.tr.open_modrinth","fallback":"Opens the official Modrinth page","color":"gray"}}}," v3.0.1 ",{"translate":"blue.tr.was_updated","fallback":"was updated.\n","color":"gray"}]
execute unless score #.TrimsOverhaul blue.misc = #.TrimsOverhaul blue.misc run tellraw @a ["",{"translate":"blue.tr.trims_overhaul","fallback":"Trims Overhaul","underlined":true,"color":"#3aa56a","clickEvent":{"action":"open_url","value":"https://modrinth.com/datapack/trims-overhaul"},"click_event":{"action":"open_url","url":"https://modrinth.com/datapack/trims-overhaul"},"hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.open_modrinth","fallback":"Opens the official Modrinth page","color":"gray"}},"hover_event":{"action":"show_text","value":{"translate":"blue.tr.open_modrinth","fallback":"Opens the official Modrinth page","color":"gray"}}}," v3.0.1 ",{"translate":"blue.tr.was_installed","fallback":"has been installed.\n","color":"gray"}]
scoreboard players set #.TrimsOverhaul blue.misc -301
