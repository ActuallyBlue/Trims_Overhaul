execute as @e[tag=blue.tr.silence.Silent] run data modify entity @s Silent set value 0b
execute as @e[tag=blue.tr.spire.NoGravity] run data modify entity @s NoGravity set value 0b
execute if score #.tr.objective_type blue.config matches 2 run scoreboard objectives add blue.tr.rtd_time dummy
execute if score #.tr.objective_type blue.config matches 2 run scoreboard objectives add blue.tr.rtd_value dummy
...
execute unless score #.difficulty blue.misc matches 1..3 run scoreboard players set #.difficulty blue.misc 2
execute unless data storage blue:trims logs.update.322 store result storage blue:trims logs.update.322 int 0.00083334 run time query gametime
execute unless data storage blue:trims logs.installation store result storage blue:trims logs.installation int 0.00083334 run time query gametime
execute if score #.Trims_Overhaul blue.misc = #.Trims_Overhaul blue.misc run tellraw @a ["\n",{"translate":"blue.tr.trims_overhaul","fallback":"Trims Overhaul","underlined":true,"color":"#3aa56a","clickEvent":{"action":"open_url","value":"https://modrinth.com/datapack/trims-overhaul"},"click_event":{"action":"open_url","url":"https://modrinth.com/datapack/trims-overhaul"},"hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.open_modrinth","fallback":"Opens the official Modrinth page","color":"gray"}},"hover_event":{"action":"show_text","value":{"translate":"blue.tr.open_modrinth","fallback":"Opens the official Modrinth page","color":"gray"}}}," v3.2.2 ",{"translate":"blue.tr.was_updated","fallback":"was updated.\n","color":"gray"}]
execute unless score #.Trims_Overhaul blue.misc = #.Trims_Overhaul blue.misc run tellraw @a ["\n",{"translate":"blue.tr.trims_overhaul","fallback":"Trims Overhaul","underlined":true,"color":"#3aa56a","clickEvent":{"action":"open_url","value":"https://modrinth.com/datapack/trims-overhaul"},"click_event":{"action":"open_url","url":"https://modrinth.com/datapack/trims-overhaul"},"hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.open_modrinth","fallback":"Opens the official Modrinth page","color":"gray"}},"hover_event":{"action":"show_text","value":{"translate":"blue.tr.open_modrinth","fallback":"Opens the official Modrinth page","color":"gray"}}}," v3.2.2 ",{"translate":"blue.tr.was_installed","fallback":"has been installed.\n","color":"gray"}]
execute if score #.Trims_Overhaul blue.misc matches ..313 run scoreboard players set #.sentry.bonus_emeralds blue.config 100
execute if score #.Trims_Overhaul blue.misc matches ..313 run scoreboard players set #.silence.bonus_shards blue.config 100
execute if score #.Trims_Overhaul blue.misc matches ..313 run scoreboard players set #.snout.gamble_multiplier blue.config 15
execute if score #.Trims_Overhaul blue.misc matches ..313 run scoreboard players set #.snout.gamble_limit blue.config 4
execute if score #.Trims_Overhaul blue.misc matches ..313 run scoreboard players set #.eye.disfigure_time blue.config 30
execute if score #.Trims_Overhaul blue.misc matches ..313 run scoreboard players set #.shaper.throw_cooldown blue.config 15
execute if score #.Trims_Overhaul blue.misc matches ..313 run scoreboard players set #.wild.trap_limit blue.config 6
execute if score #.Trims_Overhaul blue.misc matches ..313 run scoreboard players set #.tr.first_player blue.misc 1
execute if score #.Trims_Overhaul blue.misc matches ..320 run scoreboard objectives add blue.tr.used_pearl used:ender_pearl
execute if score #.Trims_Overhaul blue.misc matches ..320 run scoreboard objectives add blue.tr.salmon_cooldown dummy
scoreboard players set #.Trims_Overhaul blue.misc 322
data merge storage blue:trims {flow:{Motion:[0.0d,0.0d,0.0d]},merge:{aec:{Owner:[I;0,0,0,0],Effects:[{Id:32,Amplifier:1b,Duration:1,ShowIcon:1b,ShowParticles:0b}],effects:[{id:"minecraft:hero_of_the_village",duration:1,amplifier:1,show_icon:1b,show_particles:0b}],potion_contents:{"custom_effects":[{id:"minecraft:hero_of_the_village",duration:1,amplifier:1,show_icon:1b,show_particles:0b}]}},orb:{Value:1s,Tags:["blue.tr.raiser.orb"],Age:5400s,Motion:[0.0d,0.0d,0.0d]},boost:{acceleration_power:0.25d,Tags:["blue.tr.checked","blue.tr.flow.proj"]},wind:{acceleration_power:0.35d,Tags:["blue.tr.checked","blue.tr.flow.proj"]},return_item:{PickupDelay:0s,Age:-32768,Health:32767s,Invulnerable:1b,Motion:[0.0d,0.0d,0.0d]},item_data:{PickupDelay:0s,Age:-32768,Health:32767s,Invulnerable:1b,Glowing:1b},shortcut:{PickupDelay:20s,Motion:[0d,0d,0d],Tags:[],Thrower:[I;0,0,0,0]},tnt:{Tags:["blue.tr.shaper.tnt"],Fuse:30s,fuse:30s,explosion_power:2.5}},materials:{"minecraft:quartz":"minecraft:quartz","minecraft:iron":"minecraft:iron_ingot","minecraft:gold":"minecraft:gold_ingot","minecraft:emerald":"minecraft:emerald","minecraft:diamond":"minecraft:diamond","minecraft:redstone":"minecraft:redstone","minecraft:resin":"minecraft:resin_brick","minecraft:lapis":"minecraft:lapis_lazuli","minecraft:copper":"minecraft:copper_ingot","minecraft:ender_eye":"minecraft:ender_eye","minecraft:gunpowder":"minecraft:gunpowder","minecraft:echo_shard":"minecraft:echo_shard","minecraft:dragon_egg":"minecraft:dragon_egg","minecraft:nether_star":"minecraft:nether_star","minecraft:amethyst":"minecraft:amethyst_shard","minecraft:wind_charge":"minecraft:wind_charge","minecraft:netherite":"minecraft:netherite_ingot","minecraft:blaze_powder":"minecraft:blaze_powder","minecraft:shulker_shell":"minecraft:shulker_shell","minecraft:nautilus_shell":"minecraft:nautilus_shell","minecraft:heart_of_the_sea":"minecraft:heart_of_the_sea"},translations:[{"value":1,"trim":"coast","translate":"Coast","color":"#C1C888"},{"value":2,"trim":"dune","translate":"Dune","color":"#E7C547"},{"value":3,"trim":"eye","translate":"Eye","color":"#1F8A46"},{"value":4,"trim":"host","translate":"Host","color":"#A34646"},{"value":5,"trim":"raiser","translate":"Raiser","color":"#95B623"},{"value":6,"trim":"rib","translate":"Rib","color":"#E6484B"},{"value":7,"trim":"sentry","translate":"Sentry","color":"#4B885B"},{"value":8,"trim":"shaper","translate":"Shaper","color":"#8F8F8F"},{"value":9,"trim":"silence","translate":"Silence","color":"#3842Cf"},{"value":10,"trim":"snout","translate":"Snout","color":"#F2B01A"},{"value":11,"trim":"spire","translate":"Spire","color":"#BE20C7"},{"value":12,"trim":"tide","translate":"Tide","color":"#199ADD"},{"value":13,"trim":"vex","translate":"Vex","color":"#CFC6A5"},{"value":14,"trim":"ward","translate":"Ward","color":"#5C70AE"},{"value":15,"trim":"wayfinder","translate":"Wayfinder","color":"#F1FFC8"},{"value":16,"trim":"wild","translate":"Wild","color":"#00D529"},{"value":17,"trim":"bolt","translate":"Bolt","color":"#B65D1A"},{"value":18,"trim":"flow","translate":"Flow","color":"#85B2C5"}],unlock_text:{"text":"- ","color":"dark_gray","hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.unlock_note","fallback":"Click here to open the objective Wiki","color":"gray"}},"hover_event":{"action":"show_text","value":{"translate":"blue.tr.unlock_note","fallback":"Click here to open the objective Wiki","color":"gray"}},"clickEvent":{"action":"open_url","value":"https://github.com/ActuallyBlue/Trims_Overhaul/wiki/4.-Abilities,-Quests,-and-Tasks."},"click_event":{"action":"open_url","url":"https://github.com/ActuallyBlue/Trims_Overhaul/wiki/4.-Abilities,-Quests,-and-Tasks."}},combat_badge:{"text":" ⚔","hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.combat_badge","fallback":"This ability is affected by the %s (being hit recently)","with":[{"translate":"blue.tr.adv.combat.title","fallback":"Combat Timer","color":"white"}],"color":"gray"}},"hover_event":{"action":"show_text","value":{"translate":"blue.tr.combat_badge","fallback":"This ability is affected by the %s (being hit recently)","with":[{"translate":"blue.tr.adv.combat.title","fallback":"Combat Timer","color":"white"}],"color":"gray"}},"color":"gray"},trust_badge:{"text":" ⛨","hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.trust_badge","fallback":"This entire ability is affected by the trust system. Click for a shortcut","color":"gray"}},"clickEvent":{"action":"run_command","command":"/trigger Trims_Menu.BLUE set 1000"},"hover_event":{"action":"show_text","value":{"translate":"blue.tr.trust_badge","fallback":"This entire ability is affected by the trust system. Click for a shortcut","color":"gray"}},"click_event":{"action":"run_command","command":"/trigger Trims_Menu.BLUE set 1000"},"color":"gray"},partial_trust_badge:{"text":" ~⛨","hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.partial_trust_badge","fallback":"Only parts of this ability are affected by the trust system. Click for a shortcut","color":"gray"}},"clickEvent":{"action":"run_command","command":"/trigger Trims_Menu.BLUE set 1000"},"hover_event":{"action":"show_text","value":{"translate":"blue.tr.partial_trust_badge","fallback":"Only parts of this ability are affected by the trust system. Click for a shortcut","color":"gray"}},"click_event":{"action":"run_command","command":"/trigger Trims_Menu.BLUE set 1000"},"color":"gray"},fear_text:{"translate":"blue.tr.fear_name","fallback":"Fear","hoverEvent":{"action":"show_text","contents":[{"translate":"blue.tr.fear_hover","fallback":"Fear causes random hallucinations based on amount, such as sounds, forced movement, fake hits, and more. Trusted players lose fear faster but are still affected. Hold an Eye of Ender to check a player's Fear.","color":"gray"},{"text":" ~⛨"}]},"hover_event":{"action":"show_text","value":[{"translate":"blue.tr.fear_hover","fallback":"Fear causes random hallucinations based on amount, such as sounds, forced movement, fake hits, and more. Trusted players lose fear faster but are still affected. Hold an Eye of Ender to check a player's Fear.","color":"gray"},{"text":" ~⛨"}]},"color":"#008b00"},muffle_text:{"translate":"blue.tr.muffle_name","fallback":"Muffle","hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.muffle_description","fallback":"When a player is muffled, most of their sounds immediately end with constant background noise.","color":"gray"}},"hover_event":{"action":"show_text","value":{"translate":"blue.tr.muffle_description","fallback":"When a player is muffled, most of their sounds immediately end with constant background noise.","color":"gray"}},"color":"#4751e4"}}
execute unless data storage blue:trims wayfinder.owner run data merge storage blue:trims {wayfinder:{owner:{"translate":"gui.none","color":"dark_gray"}},silence:{owner:{"translate":"gui.none","color":"dark_gray"}},shaper:{owner:{"translate":"gui.none","color":"dark_gray"}},raiser:{owner:{"translate":"gui.none","color":"dark_gray"}},sentry:{owner:{"translate":"gui.none","color":"dark_gray"}},spire:{owner:{"translate":"gui.none","color":"dark_gray"}},coast:{owner:{"translate":"gui.none","color":"dark_gray"}},snout:{owner:{"translate":"gui.none","color":"dark_gray"}},ward:{owner:{"translate":"gui.none","color":"dark_gray"}},bolt:{owner:{"translate":"gui.none","color":"dark_gray"}},flow:{owner:{"translate":"gui.none","color":"dark_gray"}},dune:{owner:{"translate":"gui.none","color":"dark_gray"}},wild:{owner:{"translate":"gui.none","color":"dark_gray"}},tide:{owner:{"translate":"gui.none","color":"dark_gray"}},host:{owner:{"translate":"gui.none","color":"dark_gray"}},eye:{owner:{"translate":"gui.none","color":"dark_gray"}},rib:{owner:{"translate":"gui.none","color":"dark_gray"}},vex:{owner:{"translate":"gui.none","color":"dark_gray"}}}
...
execute unless score #.flow.gust_strength blue.config matches 0.. run scoreboard players set #.flow.gust_strength blue.config 17
execute unless score #.bolt.placement_range blue.config matches 0.. run scoreboard players set #.bolt.placement_range blue.config 35
execute unless score #.eye.disfigure_time blue.config matches 0 run scoreboard players set #.eye.disfigure_time blue.config 30
execute unless score #.ward.auto_damage blue.config matches 0 run scoreboard players set #.ward.auto_damage blue.config 6
execute unless score #.wild.trap_limit blue.config matches -1.. run scoreboard players set #.wild.trap_limit blue.config 6
execute unless score #.snout.gamble_multiplier blue.config matches 0.. run scoreboard players set #.snout.gamble_multiplier blue.config 15
execute unless score #.snout.gamble_limit blue.config matches -1.. run scoreboard players set #.snout.gamble_limit blue.config 4
execute unless score #.shaper.throw_cooldown blue.config matches -1.. run scoreboard players set #.shaper.throw_cooldown blue.config 15
...
execute unless score #.rib.strict_projectile blue.config matches 0.. run scoreboard players set #.rib.strict_projectile blue.config 1
...
execute unless score #.sentry.charge_speed blue.config matches 0.. run scoreboard players set #.sentry.charge_speed blue.config 5
execute unless score #.sentry.bonus_emeralds blue.config matches 0.. run scoreboard players set #.sentry.bonus_emeralds blue.config 100
execute unless score #.silence.bonus_shards blue.config matches 0.. run scoreboard players set #.silence.bonus_shards blue.config 100
...
execute unless score #.vex.quick_lunge blue.config matches 0.. run scoreboard players set #.vex.quick_lunge blue.config 0
execute unless score #.raiser.limit blue.config matches 0.. run scoreboard players set #.raiser.limit blue.config 125
execute unless score #.raiser.multiplier blue.config matches 0.. run scoreboard players set #.raiser.multiplier blue.config 100
...
execute unless score #.tr.ability_shortcuts blue.config matches 0.. run scoreboard players set #.tr.ability_shortcuts blue.config 0
...
execute unless score #.tr.death_untrim blue.config matches 0.. run scoreboard players set #.tr.death_untrim blue.config 1
...
execute unless score #.tr.trim_locator_bar blue.config matches 0.. run scoreboard players set #.tr.trim_locator_bar blue.config 0
...
execute unless score #.tr.vex_task blue.config matches 0.. run scoreboard players set #.tr.vex_task blue.config 250
execute unless score #.tr.eye_task blue.config matches 0.. run scoreboard players set #.tr.eye_task blue.config 125
execute unless score #.tr.sentry_quest blue.config matches 0.. run scoreboard players set #.tr.sentry_quest blue.config 7
execute unless score #.tr.eye_quest blue.config matches 0.. run scoreboard players set #.tr.eye_quest blue.config 12
execute unless score #.tr.dune_quest blue.config matches 0.. run scoreboard players set #.tr.dune_quest blue.config 6
execute unless score #.tr.host_quest blue.config matches 0.. run scoreboard players set #.tr.host_quest blue.config 14
execute unless score #.tr.ward_quest blue.config matches 0.. run scoreboard players set #.tr.ward_quest blue.config 12
execute unless score #.tr.wild_quest_tames blue.config matches 0.. run scoreboard players set #.tr.wild_quest_tames blue.config 8
execute unless score #.tr.wild_quest_cave blue.config matches 0.. run scoreboard players set #.tr.wild_quest_cave blue.config 6
