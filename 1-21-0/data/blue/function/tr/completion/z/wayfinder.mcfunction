...
execute if score @s blue.tr.structures matches 22 run return run particle enchant ~ ~2 ~ 0.4 0.6 0.4 5 256
...
execute if score @s blue.tr.structures matches 32 run return run particle enchant ~ ~2 ~ 0.4 0.6 0.4 5 512
