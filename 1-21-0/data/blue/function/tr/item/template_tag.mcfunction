...
execute if items entity @s contents spire_armor_trim_smithing_template run tp @s @a[tag=blue.tr.spire,limit=1]
execute if items entity @s contents spire_armor_trim_smithing_template run return run tag @s add blue.tr.spire_item
execute if items entity @s contents wild_armor_trim_smithing_template run tp @s @a[tag=blue.tr.wild,limit=1]
execute if items entity @s contents wild_armor_trim_smithing_template run return run tag @s add blue.tr.wild_item
execute if items entity @s contents wayfinder_armor_trim_smithing_template run tp @s @a[tag=blue.tr.wayfinder,limit=1]
...
execute if items entity @s contents tide_armor_trim_smithing_template run tp @s @a[tag=blue.tr.tide,limit=1]
execute if items entity @s contents tide_armor_trim_smithing_template run return run tag @s add blue.tr.tide_item
execute if items entity @s contents eye_armor_trim_smithing_template run tp @s @a[tag=blue.tr.eye,limit=1]
execute if items entity @s contents eye_armor_trim_smithing_template run return run tag @s add blue.tr.eye_item
execute if items entity @s contents rib_armor_trim_smithing_template run tp @s @a[tag=blue.tr.rib,limit=1]
execute if items entity @s contents rib_armor_trim_smithing_template run return run tag @s add blue.tr.rib_item
execute if items entity @s contents flow_armor_trim_smithing_template run tp @s @a[tag=blue.tr.flow,limit=1]
execute if items entity @s contents bolt_armor_trim_smithing_template run return run tag @s add blue.tr.bolt_item
execute if items entity @s contents bolt_armor_trim_smithing_template run tp @s @a[tag=blue.tr.bolt,limit=1]
execute if items entity @s contents flow_armor_trim_smithing_template run return run tag @s add blue.tr.flow_item
execute if items entity @s contents snout_armor_trim_smithing_template run tp @s @a[tag=blue.tr.snout,limit=1]
execute if items entity @s contents snout_armor_trim_smithing_template run return run tag @s add blue.tr.snout_item
execute if items entity @s contents dune_armor_trim_smithing_template run tp @s @a[tag=blue.tr.dune,limit=1]
execute if items entity @s contents dune_armor_trim_smithing_template run return run tag @s add blue.tr.dune_item
execute if items entity @s contents raiser_armor_trim_smithing_template run tp @s @a[tag=blue.tr.raiser,limit=1]
execute if items entity @s contents raiser_armor_trim_smithing_template run return run tag @s add blue.tr.raiser_item
execute if items entity @s contents host_armor_trim_smithing_template run tp @s @a[tag=blue.tr.host,limit=1]
execute if items entity @s contents host_armor_trim_smithing_template run return run tag @s add blue.tr.host_item
execute if items entity @s contents coast_armor_trim_smithing_template run tp @s @a[tag=blue.tr.coast,limit=1]
execute if items entity @s contents coast_armor_trim_smithing_template run return run tag @s add blue.tr.coast_item
execute if items entity @s contents sentry_armor_trim_smithing_template run tp @s @a[tag=blue.tr.sentry,limit=1]
execute if items entity @s contents sentry_armor_trim_smithing_template run return run tag @s add blue.tr.sentry_item
execute if items entity @s contents vex_armor_trim_smithing_template run tp @s @a[tag=blue.tr.vex,limit=1]
execute if items entity @s contents vex_armor_trim_smithing_template run return run tag @s add blue.tr.vex_item
execute if items entity @s contents ward_armor_trim_smithing_template run tp @s @a[tag=blue.tr.ward,limit=1]
