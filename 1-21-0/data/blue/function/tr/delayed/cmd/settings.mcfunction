...
execute if score #.tr.bolt_toggle blue.config matches 0 run data modify storage blue:trims display append value [{"translate":"Bolt","color":"#B65D1A"},{"text":", ","color":"dark_gray"}]
execute if score #.tr.flow_toggle blue.config matches 0 run data modify storage blue:trims display append value [{"translate":"Flow","color":"#85B2C5"},{"text":", ","color":"dark_gray"}]
