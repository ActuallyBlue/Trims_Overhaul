...
execute if score #.temp blue.misc matches 1 run advancement revoke @s only blue:tr/tags tutorial_barrage
...
execute if score #.temp blue.misc matches 1 run return run advancement revoke @s only blue:tr/tags tutorial_transfer
