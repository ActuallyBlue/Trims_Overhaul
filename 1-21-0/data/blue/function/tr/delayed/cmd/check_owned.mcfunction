...
execute if entity @s[tag=blue.tr.eye,tag=blue.tr.rib,tag=blue.tr.vex,tag=blue.tr.tide,tag=blue.tr.ward,tag=blue.tr.dune,tag=blue.tr.wild,tag=blue.tr.host,tag=blue.tr.snout,tag=blue.tr.coast,tag=blue.tr.spire,tag=blue.tr.sentry,tag=blue.tr.shaper,tag=blue.tr.raiser,tag=blue.tr.silence,tag=blue.tr.wayfinder,tag=blue.tr.flow,tag=blue.tr.bolt] run return run tellraw @s [{"translate":"blue.tr.you_own","fallback":"Owned Trims","color":"gray"},{"text":": ","color":"dark_gray"},{"translate":"gui.all","color":"dark_green","extra":[".."]}]
execute if entity @s[tag=!blue.tr.wayfinder,tag=!blue.tr.silence,tag=!blue.tr.shaper,tag=!blue.tr.raiser,tag=!blue.tr.sentry,tag=!blue.tr.flow,tag=!blue.tr.bolt,tag=!blue.tr.spire,tag=!blue.tr.coast,tag=!blue.tr.snout,tag=!blue.tr.ward,tag=!blue.tr.dune,tag=!blue.tr.wild,tag=!blue.tr.tide,tag=!blue.tr.host,tag=!blue.tr.eye,tag=!blue.tr.rib,tag=!blue.tr.vex] run return run tellraw @s [{"translate":"blue.tr.you_own","fallback":"Owned Trims","color":"gray"},{"text":": ","color":"dark_gray"},{"translate":"gui.none","color":"dark_red"}]
...
execute if entity @s[tag=blue.tr.bolt] run data modify storage blue:trims display append value [{"translate":"Bolt","color":"#B65D1A"},{"text":", ","color":"dark_gray"}]
execute if entity @s[tag=blue.tr.flow] run data modify storage blue:trims display append value [{"translate":"Flow","color":"#85B2C5"},{"text":", ","color":"dark_gray"}]
