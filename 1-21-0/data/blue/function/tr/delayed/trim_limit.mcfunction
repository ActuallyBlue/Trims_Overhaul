...
execute if score #.tr.limit_owned_trims blue.config matches 1 run return run advancement revoke @s[advancements={blue:tr/tags={trim_limit=true}},tag=!blue.tr.wayfinder,tag=!blue.tr.silence,tag=!blue.tr.shaper,tag=!blue.tr.raiser,tag=!blue.tr.sentry,tag=!blue.tr.spire,tag=!blue.tr.coast,tag=!blue.tr.snout,tag=!blue.tr.ward,tag=!blue.tr.bolt,tag=!blue.tr.flow,tag=!blue.tr.dune,tag=!blue.tr.wild,tag=!blue.tr.tide,tag=!blue.tr.host,tag=!blue.tr.eye,tag=!blue.tr.rib,tag=!blue.tr.vex] only blue:tr/tags trim_limit
...
execute if entity @s[tag=blue.tr.bolt] run scoreboard players add #.temp blue.misc 1
execute if entity @s[tag=blue.tr.flow] run scoreboard players add #.temp blue.misc 1
...
execute if score #.temp blue.misc >= #.tr.limit_owned_trims blue.config run return run advancement grant @s only blue:tr/tags trim_limit
