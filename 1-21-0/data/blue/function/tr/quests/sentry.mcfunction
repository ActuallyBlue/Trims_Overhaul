...
execute positioned ~ ~3 ~ store result entity @n[type=area_effect_cloud,tag=blue.tr.sentry_quest,distance=..0.1] Duration int 0.1 run scoreboard players get #.temp blue.misc
