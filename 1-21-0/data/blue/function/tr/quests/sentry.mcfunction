...
execute positioned ~ ~3 ~ store result entity @n[tag=blue.tr.sentry_quest,distance=..1,type=area_effect_cloud] Duration int 120 run scoreboard players get #.temp blue.misc
...
execute if entity @e[tag=blue.tr.sentry_quest,distance=..100,limit=1,type=area_effect_cloud] run function blue:tr/completion/sentry