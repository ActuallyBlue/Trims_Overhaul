...
execute unless entity @e[tag=blue.tr.quest.eye,distance=..20,limit=1,type=area_effect_cloud] run return fail
function blue:tr/completion/eye
kill @e[tag=blue.tr.quest.eye,type=area_effect_cloud]