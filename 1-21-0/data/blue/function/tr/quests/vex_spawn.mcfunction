...
execute if entity @e[tag=blue.tr.quest.vex_passenger,predicate=blue:shared/id_link,limit=1,type=marker] run return fail
execute rotated ~ 0 positioned ^ ^ ^-9 positioned over motion_blocking_no_leaves if entity @s[distance=..14] run summon vindicator ~ ~ ~ {Tags:["blue.tr.vex","blue.tr.trim.vex","blue.tr.quest.vex_quest","smithed.entity","blue.tr.temp"],ArmorItems:[{},{id:emerald_ore},{},{}],active_effects:[{id:instant_health,amplifier:100,duration:10},{id:glowing,duration:-1},{id:invisibility,duration:-1},{id:resistance,duration:-1}],CanJoinRaid:0b,HandDropChances:[0,0],HandItems:[{id:"minecraft:iron_axe"},{id:"minecraft:iron_axe"}],ArmorDropChances:[0,0,0,0],DeathTime:-40s,equipment:{mainhand:{id:iron_axe},offhand:{id:iron_axe},legs:{id:emerald_ore}},drop_chances:{offhand:0,mainhand:0,legs:0},DeathLootTable:""}
execute rotated ~ 0 positioned ^ ^ ^-9 positioned over motion_blocking_no_leaves at @s[distance=14.01..] run summon vindicator ^ ^1 ^-2 {Tags:["blue.tr.vex","blue.tr.trim.vex","blue.tr.quest.vex_quest","smithed.entity","blue.tr.temp"],ArmorItems:[{},{id:emerald_ore},{},{}],active_effects:[{id:instant_health,amplifier:100,duration:10},{id:glowing,duration:-1},{id:invisibility,duration:-1},{id:resistance,duration:-1}],CanJoinRaid:0b,HandDropChances:[0,0],HandItems:[{id:"minecraft:iron_axe"},{id:"minecraft:iron_axe"}],ArmorDropChances:[0,0,0,0],DeathTime:-40s,equipment:{mainhand:{id:iron_axe},offhand:{id:iron_axe},legs:{id:emerald_ore}},drop_chances:{offhand:0,mainhand:0,legs:0},DeathLootTable:""}
