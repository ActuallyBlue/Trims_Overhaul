...
execute unless data storage blue:trims logs.transfer run return run tellraw @s [{"text":"- ","color":"dark_gray"},{"translate":"blue.tr.logs.empty","fallback":"Nothing has been stored in this type of log yet","color":"gray"}]
