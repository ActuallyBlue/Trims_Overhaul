...
execute as @a run function blue:tr/inv/untrim/main
...
data remove storage blue:trims bolt
data remove storage blue:trims flow
...
datapack disable "file/CUSTOM_trims_overhaul-MOD-v3.2.3.jar"
datapack disable "file/CUSTOM_trims_overhaul-DP_RP-v3.2.3.zip"
datapack disable "file/CUSTOM_trims_overhaul-DP-v3.2.3"
datapack disable "file/trims_overhaul-MOD-v3.2.3.jar"
datapack disable "file/trims_overhaul-DP_RP-v3.2.3.zip"
datapack disable "file/trims_overhaul-DP_RP-v3.2.3"
datapack disable "file/trims_overhaul-MOD-v3.2.3.jar"
datapack disable "file/trims_overhaul-DP_RP-v3.2.3.zip"
datapack disable "file/trims_overhaul-DP_RP-v3.2.3"
datapack disable "file/trims_overhaul-dp-rp-v3.2.3.zip"
datapack disable "file/trims_overhaul-dp-rp-v3.2.3"