...
execute unless data storage blue:data trims.telemetry.completion run return run tellraw @s {"translate":"blue.tr.no_telemetry","fallback":"No objectives have been completed yet"}
