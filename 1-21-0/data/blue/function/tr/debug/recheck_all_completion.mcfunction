...
execute unless data storage blue:data trims.owner.flow{text:"None"} run scoreboard players set #.tr.flow_completed blue.config 1
execute unless data storage blue:data trims.owner.bolt{text:"None"} run scoreboard players set #.tr.bolt_completed blue.config 1
