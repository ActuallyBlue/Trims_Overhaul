...
execute if entity @s[advancements={blue:tr/quests/wild_tames={nautilus=true}}] run scoreboard players add #.temp blue.misc 1
...
execute if entity @e[tag=blue.tr.tamed,distance=..14,limit=1,type=nautilus] run scoreboard players add #.temp blue.misc 1
