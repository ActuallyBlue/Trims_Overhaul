...
execute if score #.temp blue.misc matches 140.. store success score #.temp blue.misc run attribute @s[advancements={blue:tr/cure={6=true}}] generic.max_health modifier add b163102f-0-5-0-1 "blue:tr.trim" 12.6 add_value
...
execute if score #.temp blue.misc matches 80.. store success score #.temp blue.misc run attribute @s[advancements={blue:tr/cure={4=true}}] generic.max_health modifier add b163102f-0-5-0-1 "blue:tr.trim" 8 add_value
execute if score #.temp blue.misc matches 60.. store success score #.temp blue.misc run attribute @s[advancements={blue:tr/cure={3=true}}] generic.max_health modifier add b163102f-0-5-0-1 "blue:tr.trim" 6 add_value
execute if score #.temp blue.misc matches 40.. store success score #.temp blue.misc run attribute @s[advancements={blue:tr/cure={2=true}}] generic.max_health modifier add b163102f-0-5-0-1 "blue:tr.trim" 4 add_value
execute if score #.temp blue.misc matches 20.. store success score #.temp blue.misc run attribute @s[advancements={blue:tr/cure={1=true}}] generic.max_health modifier add b163102f-0-5-0-1 "blue:tr.trim" 2 add_value
execute if score #.temp blue.misc matches ..0 run attribute @s generic.max_health modifier add b163102f-0-5-0-1 "blue:tr.trim" -2 add_value