...
execute unless predicate blue:tr/in_desert run return fail
...
execute if score #.temp blue.misc matches 1 run attribute @s generic.attack_damage modifier add b163102f-0-5-0-1 "blue:tr.trim" 2.5 add_value