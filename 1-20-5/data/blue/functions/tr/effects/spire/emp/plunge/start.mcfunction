...
execute if score #.last_reversal_charge blue.misc matches ..39 run playsound entity.ender_dragon.growl player @a[x=0] ~ ~ ~ 3 2
...
execute if score #.last_reversal_charge blue.misc matches 40..54 run playsound entity.ender_dragon.growl player @a[x=0] ~ ~ ~ 4 1.8
...
execute if score #.last_reversal_charge blue.misc matches 55..69 run playsound entity.ender_dragon.growl player @a[x=0] ~ ~ ~ 14 1.4
execute if score #.last_reversal_charge blue.misc matches 70.. run particle dragon_breath ~ ~ ~ 0.4 0.4 0.4 0.6 128 force
execute if score #.last_reversal_charge blue.misc matches 70.. run playsound entity.ender_dragon.growl player @a[x=0] ~ ~ ~ 20 1
...
execute if score #.last_reversal_charge blue.misc matches 55.. run scoreboard players set #.reversal_charge blue.misc -1000