...
execute if score #.can_plunge blue.misc matches 1 unless score #.spire.limit_plunge blue.config matches 0 rotated ~ 20 run function blue:tr/effects/spire/emp/plunge/cast
...
summon area_effect_cloud ~ ~ ~ {Rotation:[0,180],Tags:["blue.tr.plunge_aec"],Particle:{type:"witch"},Duration:30,Radius:3,RadiusPerTick:0.5}
