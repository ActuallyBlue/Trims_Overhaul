...
summon area_effect_cloud ~ ~ ~ {Rotation:[0,180],Tags:["blue.tr.blast-o-breath"],"potion_contents":{"potion":"harming"},custom_particle:{type:"block",block_state:"air"},Duration:16,Radius:0.5,RadiusPerTick:0.15,ReapplicationDelay:0,WaitTime:0s}
...
summon area_effect_cloud ~ ~ ~ {Rotation:[0,180],Particle:{type:"dragon_breath"},Duration:15,Radius:1.5,RadiusPerTick:0.1,WaitTime:0s}
