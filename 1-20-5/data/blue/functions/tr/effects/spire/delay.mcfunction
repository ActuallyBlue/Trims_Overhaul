...
execute if score #.temp blue.misc matches 1 run attribute @s generic.attack_damage modifier add b163102f-0-5-0-1 "blue:tr.trim" 1.5 add_value
execute if score #.temp blue.misc matches 1 run return run attribute @s generic.armor modifier add b163102f-0-5-0-1 "blue:tr.trim" 4 add_value
