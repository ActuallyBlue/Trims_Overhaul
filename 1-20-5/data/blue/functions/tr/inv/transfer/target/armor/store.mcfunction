...
execute store result score #.temp0 blue.misc run data get storage blue:data trims.transfer
execute store result score #.temp blue.misc if data storage blue:data trims.transfer[{components:{"minecraft:trim":{}}}]