...
data modify storage blue:data trims.transfer[{Slot:3b}].components."minecraft:trim" set from storage blue:data trims.inventory[{Slot:3b}].components."minecraft:trim"
data modify storage blue:data trims.transfer[{Slot:2b}].components."minecraft:trim" set from storage blue:data trims.inventory[{Slot:2b}].components."minecraft:trim"
data modify storage blue:data trims.transfer[{Slot:1b}].components."minecraft:trim" set from storage blue:data trims.inventory[{Slot:1b}].components."minecraft:trim"
data modify storage blue:data trims.transfer[{Slot:0b}].components."minecraft:trim" set from storage blue:data trims.inventory[{Slot:0b}].components."minecraft:trim"
