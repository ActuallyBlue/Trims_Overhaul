...
execute if score #.tr.first_player blue.misc matches 1.. run return 0
execute unless score #.Trims_Overhaul blue.misc = #.Trims_Overhaul blue.misc run tellraw @s [{"translate":"blue.faulty_datapack.title","fallback":"\n The world has a datapack which breaks the rest.","bold":true,"color":"dark_red"},{"translate":"blue.faulty_datapack.description","fallback":"\n In your world's %s file, located in the first %s folder, search for %s and %s, then remove the datapacks listed at the end. If you don't want to, or need help; feel free to ask for assistance.\n Click here to join Blue's server.\n","clickEvent":{"action":"open_url","value":"https://discord.gg/TsC8AnaZeV"},"color":"gray","bold":false,"with":[{"text":"latest.log","italic":true,"color":"white"},{"text":"\\logs","italic":true,"color":"white"},{"text":"minecraft:load","italic":true,"color":"white"},{"text":"minecraft:tick","italic":true,"color":"white"}]}]
