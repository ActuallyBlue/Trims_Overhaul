...
advancement grant @a only blue:tr/display/host
...
execute at @e[type=!#blue:shared/no_effects,tag=!smithed.strict,distance=0.01..12,sort=random,limit=1] run summon marker ~ ~ ~ {UUID:[I;-1318907857,11,0,1]}
execute at b163102f-0-b-0-1 as @e[type=!#blue:shared/no_effects,tag=!smithed.strict,distance=..0.01,limit=1] at @p[tag=blue.tr.host] run tp ~ ~ ~
