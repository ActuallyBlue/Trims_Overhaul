...
execute if data storage blue:trims temp.elytra.tag.Trim{} run return 0
data modify storage blue:trims temp.elytra.tag.Trim set from storage blue:trims temp.elytra.tag.armElyData.chestplate.tag.Trim
data remove storage blue:trims temp.elytra.tag.armElyData.chestplate.tag.Trim
