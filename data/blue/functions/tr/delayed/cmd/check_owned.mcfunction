...
execute if entity @s[tag=blue.tr.eye,tag=blue.tr.rib,tag=blue.tr.vex,tag=blue.tr.tide,tag=blue.tr.ward,tag=blue.tr.dune,tag=blue.tr.wild,tag=blue.tr.host,tag=blue.tr.snout,tag=blue.tr.coast,tag=blue.tr.spire,tag=blue.tr.sentry,tag=blue.tr.shaper,tag=blue.tr.raiser,tag=blue.tr.silence,tag=blue.tr.wayfinder] run scoreboard players set #.temp0 blue.misc 2
execute if entity @s[tag=!blue.tr.wayfinder,tag=!blue.tr.silence,tag=!blue.tr.shaper,tag=!blue.tr.raiser,tag=!blue.tr.sentry,tag=!blue.tr.spire,tag=!blue.tr.coast,tag=!blue.tr.snout,tag=!blue.tr.ward,tag=!blue.tr.dune,tag=!blue.tr.wild,tag=!blue.tr.tide,tag=!blue.tr.host,tag=!blue.tr.eye,tag=!blue.tr.rib,tag=!blue.tr.vex] run scoreboard players set #.temp0 blue.misc 1
execute if score #.temp0 blue.misc matches 2 run tellraw @s [{"translate":"blue.tr.you_own","fallback":"Owned Trims","color":"gray"},{"text":": ","color":"dark_gray"},{"translate":"gui.all","color":"dark_green","extra":[".."]}]
execute if score #.temp0 blue.misc matches 1 run tellraw @s [{"translate":"blue.tr.you_own","fallback":"Owned Trims","color":"gray"},{"text":": ","color":"dark_gray"},{"translate":"gui.none","color":"dark_red"}]
