execute store success score #.temp blue.misc if entity @s[advancements={blue:tr/tags={tutorial_barrage=true,tutorial_piercer=true,tutorial_vortex=true,tutorial_resource_pack=true,tutorial_pickup_trim=true,tutorial_new_player=true,tutorial_creative=true,tutorial_transfer=true,tutorial_unowned=true,tutorial_defender=true}}]
...
execute if score #.temp blue.misc matches 1 run advancement revoke @s only blue:tr/tags tutorial_defender
...
execute if score #.temp blue.misc matches 1 run advancement revoke @s only blue:tr/tags tutorial_unowned
...
execute if score #.temp blue.misc matches 0 run advancement grant @s only blue:tr/tags tutorial_defender
