...
execute if score @s blue.tr.combat matches 0.. run title @s actionbar {"translate":"blue.tr.out_combat","fallback":"You've been out of combat for %s seconds","color":"gray","with":[{"storage":"blue:trims","nbt":"temp.s1","color":"white","interpret":true}]}
execute if score @s blue.tr.combat matches 0.. run return 0
