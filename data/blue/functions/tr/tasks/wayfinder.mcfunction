...
execute unless score @s blue.tr.structures matches 12.. if score @s blue.tr.blocks_walked >= #.temp blue.misc unless score #.tr.wayfinder_completed blue.config matches 1 at @s run function blue:tr/completion/z/wayfinder
scoreboard players operation #.temp blue.misc += #.tr.wayfinder_task blue.config
...
execute if score @s blue.tr.structures matches 12..21 if score @s blue.tr.blocks_walked >= #.temp blue.misc at @s run function blue:tr/completion/z/wayfinder
scoreboard players operation #.temp blue.misc += #.tr.wayfinder_task blue.config
...
execute if score @s blue.tr.structures matches 22..31 if score @s blue.tr.blocks_walked >= #.temp blue.misc at @s run function blue:tr/completion/z/wayfinder
