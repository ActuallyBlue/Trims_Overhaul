...
execute unless score #.tr.random_task_defender blue.config matches 0 if score #.temp blue.misc matches 625.. unless entity @s[tag=blue.tr.rtd_cooldown] run function blue:tr/tasks/rtd/silence