...
data modify storage blue:data trims.armor.head set from storage blue:data trims.inventory[{Slot:3b}].tag.Trim
data modify storage blue:data trims.armor.chest set from storage blue:data trims.inventory[{Slot:2b}].tag.Trim
data modify storage blue:data trims.armor.legs set from storage blue:data trims.inventory[{Slot:1b}].tag.Trim
data modify storage blue:data trims.armor.feet set from storage blue:data trims.inventory[{Slot:0b}].tag.Trim
