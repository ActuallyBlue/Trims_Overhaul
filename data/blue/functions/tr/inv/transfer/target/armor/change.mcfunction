...
data modify storage blue:data trims.transfer[{Slot:7b}].tag.Trim set from storage blue:data trims.inventory[{Slot:7b}].tag.Trim
data modify storage blue:data trims.transfer[{Slot:6b}].tag.Trim set from storage blue:data trims.inventory[{Slot:6b}].tag.Trim
data modify storage blue:data trims.transfer[{Slot:5b}].tag.Trim set from storage blue:data trims.inventory[{Slot:5b}].tag.Trim
data modify storage blue:data trims.transfer[{Slot:4b}].tag.Trim set from storage blue:data trims.inventory[{Slot:4b}].tag.Trim
