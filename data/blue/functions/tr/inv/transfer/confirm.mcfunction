execute if score #.tr.manual_transferring blue.config matches 0 unless entity @s[gamemode=creative] run tellraw @s [{"text":"- ","color":"dark_gray"},{"translate":"blue.tr.manual_transferring","fallback":"Manual Transferring","color":"white"},{"translate":"blue.tr.is_disabled","fallback":" is disabled on this server","color":"gray"}]
