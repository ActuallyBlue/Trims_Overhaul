execute if score #.tr.eye_toggle blue.config matches 2 run tellraw @s {"translate":"blue.tr.empowerment_disabled","fallback":"- %s empowerment is disabled on this server.","color":"gray","with":[{"translate":"Eye","extra":["'s"],"color":"#1F8A46"}]}
