...
data modify storage blue:trims armor.head{pattern:"minecraft:dragon_egg"} set from storage blue:trims armor.feet
data modify storage blue:trims armor.chest{material:"minecraft:dragon_egg"} set from storage blue:trims armor.head
data modify storage blue:trims armor.chest{pattern:"minecraft:dragon_egg"} set from storage blue:trims armor.head
data modify storage blue:trims armor.legs{material:"minecraft:dragon_egg"} set from storage blue:trims armor.chest
data modify storage blue:trims armor.legs{pattern:"minecraft:dragon_egg"} set from storage blue:trims armor.chest
data modify storage blue:trims armor.feet{material:"minecraft:dragon_egg"} set from storage blue:trims armor.legs
data modify storage blue:trims armor.feet{pattern:"minecraft:dragon_egg"} set from storage blue:trims armor.legs
