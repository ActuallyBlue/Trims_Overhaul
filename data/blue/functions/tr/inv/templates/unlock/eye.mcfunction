execute store result score #.clear_temp blue.misc run clear @s eye_armor_trim_smithing_template{blue:{trim:1b}} 0
execute store result score #.clear_temp0 blue.misc run clear @s eye_armor_trim_smithing_template 0
