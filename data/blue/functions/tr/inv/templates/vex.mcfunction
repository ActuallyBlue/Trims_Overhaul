...
execute store result score #.clear_temp blue.misc run clear @s vex_armor_trim_smithing_template{blue:{trim:1b}}
...
execute at @a[tag=blue.tr.vex,limit=1] run loot spawn ~ ~0.5 ~ loot blue:tr/vex
