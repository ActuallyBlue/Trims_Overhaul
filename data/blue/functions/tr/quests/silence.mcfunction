...
execute if score #.tr.limit_owned_trims blue.config matches 1.. if entity @s[advancements={blue:tr/tags={trim_limit=true}}] run advancement revoke @s only blue:tr/quests/silence_down
