...
execute positioned ~ ~3 ~ store result entity @e[tag=blue.tr.quest.sentry,distance=..1,sort=nearest,limit=1,type=area_effect_cloud] Duration int 120 run scoreboard players get #.temp blue.misc
