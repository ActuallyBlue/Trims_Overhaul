...
execute if entity @e[tag=blue.tr.quest.vex_passenger,predicate=blue:shared/id_link,limit=1,type=marker] run return 0
execute rotated ~ 0 positioned ^ ^ ^-9 positioned over motion_blocking_no_leaves if entity @s[distance=..14] run summon vindicator ~ ~ ~ {Tags:["blue.tr.vex","blue.tr.trim.vex","blue.tr.quest.vex_quest","smithed.entity","blue.tr.temp"],ArmorItems:[{},{id:emerald_ore,Count:1b},{},{}],ActiveEffects:[{Id:6,Amplifier:100,Duration:10},{Id:24,Duration:-1},{Id:14,Duration:-1},{Id:11,Duration:-1}],active_effects:[{id:instant_health,amplifier:100,duration:10},{id:glowing,duration:-1},{id:invisibility,duration:-1},{id:resistance,duration:-1}],CanJoinRaid:0b,ArmorDropChances:[0,0,0,0],HandDropChances:[0,0],HandItems:[{id:"minecraft:iron_axe",Count:1b},{id:"minecraft:iron_axe",Count:1b}],DeathTime:-40s,DeathLootTable:""}
execute rotated ~ 0 positioned ^ ^ ^-9 positioned over motion_blocking_no_leaves at @s[distance=14.01..] run summon vindicator ^ ^1 ^-2 {Tags:["blue.tr.vex","blue.tr.trim.vex","blue.tr.quest.vex_quest","smithed.entity","blue.tr.temp"],ArmorItems:[{},{id:emerald_ore,Count:1b},{},{}],ActiveEffects:[{Id:6,Amplifier:100,Duration:10},{Id:24,Duration:-1},{Id:14,Duration:-1},{Id:11,Duration:-1}],active_effects:[{id:instant_health,amplifier:100,duration:10},{id:glowing,duration:-1},{id:invisibility,duration:-1},{id:resistance,duration:-1}],CanJoinRaid:0b,ArmorDropChances:[0,0,0,0],HandDropChances:[0,0],HandItems:[{id:"minecraft:iron_axe",Count:1b},{id:"minecraft:iron_axe",Count:1b}],DeathTime:-40s,DeathLootTable:""}
summon marker ~ ~ ~ {Tags:["blue.tr.quest.vex_passenger"]}
effect give @e[tag=blue.tr.temp,distance=..12,limit=1,type=vindicator] health_boost infinite 10 true
scoreboard players operation @e[tag=blue.tr.quest.vex_passenger,predicate=!blue:shared/has_vehicle,distance=..1,limit=1,type=marker] blue.id = #.link blue.id
ride @e[tag=blue.tr.quest.vex_passenger,predicate=!blue:shared/has_vehicle,distance=..1,limit=1,type=marker] mount @e[tag=blue.tr.temp,distance=..12,limit=1,type=vindicator]
