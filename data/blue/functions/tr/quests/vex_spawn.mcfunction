...
scoreboard players operation @e[type=marker,tag=blue.tr.vex_passenger,distance=..1,limit=1] blue.id = #.link blue.id
ride @e[type=marker,tag=blue.tr.vex_passenger,distance=..1,limit=1] mount @e[type=vindicator,tag=blue.tr.temp,distance=..12,limit=1]
