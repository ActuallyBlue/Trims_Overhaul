...
execute if score #.host.exchange_channel blue.misc matches 5.. run particle dust 1 0.6 0.5 1 ~ ~0.7 ~ 0.3 0.5 0.3 0 6 force @a[tag=blue.tr.host,limit=1]
execute unless score #.host.exchange_channel blue.misc matches 35.. run return 0
