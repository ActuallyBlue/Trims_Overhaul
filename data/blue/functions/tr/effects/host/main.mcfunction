...
execute if score #.host.ambient blue.misc matches 1 run particle dust_color_transition 0.9 0.2 0.2 0.6 0.1 0 0 ~ ~0.8 ~ 0.25 0.3 0.25 0 1 normal @a[scores={blue.particles=2..}]
