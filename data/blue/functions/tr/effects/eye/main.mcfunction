...
execute if score #.eye.two_tick blue.misc matches 1 if predicate blue:tr/hold_ender_eye positioned ^ ^ ^5 as @p[distance=..16,tag=!blue.tr.eye,gamemode=!spectator] run function blue:tr/effects/eye/emp/display
