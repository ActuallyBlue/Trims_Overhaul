...
execute if entity @a[tag=blue.tr.eye,distance=..64,limit=1] run damage @s 14 player_attack by @a[tag=blue.tr.eye,limit=1]
execute if entity @a[tag=blue.tr.eye,distance=64.01..,limit=1] run damage @s 18 player_attack by @a[tag=blue.tr.eye,limit=1]
