scoreboard players operation #.temp blue.misc = #.eye.grand_reveal blue.misc
execute unless score #.temp blue.misc matches 60.. run scoreboard players reset #.eye.grand_reveal blue.misc
execute unless score #.temp blue.misc matches 60.. run return 0
