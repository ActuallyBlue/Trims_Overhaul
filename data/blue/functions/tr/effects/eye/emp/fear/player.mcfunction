...
execute store result score #.mult blue.misc run loot spawn 0 0 0 loot blue:tr/z/rng_63
...
execute store result score #.temp blue.misc run loot spawn 0 0 0 loot blue:tr/z/rng_63
