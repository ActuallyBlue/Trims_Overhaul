execute store result score #.block blue.misc run loot spawn 0 0 0 loot blue:tr/z/rng_12
...
execute if score #.block blue.misc matches 11 run function blue:tr/effects/eye/emp/fear/door
execute if score #.block blue.misc matches 12 run function blue:tr/effects/eye/emp/fear/anchor