...
execute unless score @s blue.tr.fear matches 1.. run title @a[tag=blue.tr.eye,limit=1] actionbar [{"translate":"blue.tr.fear_none","fallback":"%s has no Fear","color":"gray","with":[{"selector":"@s"}]}]
execute unless score @s blue.tr.fear matches 1.. run return 0
