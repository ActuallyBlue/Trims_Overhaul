execute summon area_effect_cloud store success score #.temp blue.misc run data modify storage blue:trims eye.Pos set from entity @s Pos
...
execute unless score #.eye.grand_reveal blue.misc matches 60.. run return 0
