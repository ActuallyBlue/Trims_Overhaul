...
execute if score #.eye.two_tick blue.misc matches 0 run playsound item.lodestone_compass.lock player @a[tag=blue.tr.eye,limit=1] ~ -128 ~ 0 2 0.1
...
execute if entity @s[tag=blue.tr.checked] run return 0
