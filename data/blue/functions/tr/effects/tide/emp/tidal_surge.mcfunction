...
execute positioned ~ ~-20 ~ as @e[distance=..9,type=!#blue:tr/peaceful,tag=!blue.tr.mats.heart] run damage @s 34 blue:tr/tide by @a[tag=blue.tr.mats.heart,limit=1]
particle dust_color_transition 0 0.1 1 1.3 0 0.9 1 ~ ~-19.6 ~ 4 0.4 4 0 400 force @s
particle dust_color_transition 0 0.1 1 1.4 0 0.9 1 ~ ~-19.6 ~ 4 0.4 4 0 300 force
particle dust_color_transition 0 0.1 1 1.3 0 0.9 1 ~ ~-19.6 ~ 4 0.4 4 0 800 normal @a[scores={blue.particles=1..}]
particle dust_color_transition 0 0.1 1 1.7 0 0.9 1 ~ ~-19.6 ~ 4 0.4 4 0 300 normal @a[scores={blue.particles=2..}]
particle fishing ~ ~-19.4 ~ 0 0 0 0.15 100 normal @a[scores={blue.particles=2..}]
particle fishing ~ ~-19.4 ~ 0 0 0 0.15 100
execute positioned ~ ~-19 ~ run playsound item.trident.thunder master @a[distance=..16] ~ ~ ~ 8 0.9
playsound item.trident.thunder master @a ~ ~-19 ~ 2.5 0.9
playsound item.trident.return master @a ~ ~-19 ~ 3 0.5
