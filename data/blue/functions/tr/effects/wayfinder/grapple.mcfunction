...
execute if block ~ ~-0.5 ~ #blue:shared/passable if block ~0.5 ~ ~ #blue:shared/passable if block ~-0.5 ~ ~ #blue:shared/passable if block ~ ~ ~0.5 #blue:shared/passable if block ~ ~ ~-0.5 #blue:shared/passable if block ~ ~0.5 ~ #blue:shared/passable if block ~ ~0.5 ~ #blue:shared/passable run return 0
