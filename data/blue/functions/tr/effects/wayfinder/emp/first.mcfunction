...
execute store result storage blue:data trims.temp.warp.Pos[0] double 1 run data get storage blue:data trims.temp.warp.LodestonePos.X
execute store result storage blue:data trims.temp.warp.Pos[1] double 1 run data get storage blue:data trims.temp.warp.LodestonePos.Y
execute store result storage blue:data trims.temp.warp.Pos[2] double 1 run data get storage blue:data trims.temp.warp.LodestonePos.Z
execute if data storage blue:data trims.temp.warp{LodestoneDimension:"minecraft:overworld"} in overworld run tp b163102f-0-3-0-1 ~ ~ ~
execute if data storage blue:data trims.temp.warp{LodestoneDimension:"minecraft:the_end"} in the_end run tp b163102f-0-3-0-1 ~ ~ ~
execute if data storage blue:data trims.temp.warp{LodestoneDimension:"minecraft:the_nether"} in the_nether run tp b163102f-0-3-0-1 ~ ~ ~
