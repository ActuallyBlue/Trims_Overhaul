...
execute if score #.warp_charge blue.misc matches 1.. if score #.temp blue.misc matches 1 run scoreboard players reset #.warp_charging blue.misc
execute if score #.warp_charge blue.misc matches 1.. if score #.temp blue.misc matches 1 run return 0
