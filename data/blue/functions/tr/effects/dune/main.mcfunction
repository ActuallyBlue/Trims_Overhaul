...
execute if score #.dune.ambient blue.misc matches 3 run particle falling_dust sand ~ ~0.9 ~ 0.2 0.4 0.2 0 1 normal @a[scores={blue.particles=2..}]
execute if score #.dune.ambient blue.misc matches 7.. store success score #.dune.ambient blue.misc run particle falling_dust sand ~ ~0.9 ~ 0.2 0.4 0.2 0 1 normal @a[scores={blue.particles=1..}]
execute if score #.60 blue.misc matches 23 run function blue:tr/effects/dune/endurance
execute unless score @s blue.tr.mined_sand matches 1.. run return 0
