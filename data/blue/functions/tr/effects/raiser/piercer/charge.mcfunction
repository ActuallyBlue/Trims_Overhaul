...
execute if score #.raiser.charge blue.misc matches 48.. if score #.raiser.ambient blue.misc matches 7 positioned ~ ~0.1 ~ if predicate blue:tr/hold_experience_bottle run function blue:tr/effects/raiser/piercer/spray
