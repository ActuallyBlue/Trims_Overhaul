...
execute if score #.temp blue.misc matches 0 store result score #.vex.isolation blue.misc if entity @a[gamemode=!spectator,gamemode=!creative,distance=0.01..9,limit=2]
...
execute if score #.vex.isolation blue.misc matches 1 run return 0
