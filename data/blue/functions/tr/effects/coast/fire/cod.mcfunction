...
data merge entity @s {Tags:["blue.tr.coast_projectile","blue.tr.coast_cod","smithed.entity"],teleport_duration:1,item:{id:cod,Count:1b},transformation:{scale:[0.5f,0.5f,0.5f],left_rotation:[-0.28f,-0.65f,0.28f,0.65f]}}
