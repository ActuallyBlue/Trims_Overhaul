...
data merge entity @s {Tags:["blue.tr.coast.projectile","blue.tr.coast.tropical","smithed.entity"],teleport_duration:1,item:{id:tropical_fish,Count:1b},transformation:{scale:[0.5f,0.5f,0.5f],left_rotation:[-0.28f,-0.65f,0.28f,0.65f]}}
