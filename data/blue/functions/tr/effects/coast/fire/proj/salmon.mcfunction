...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[type=!#blue:shared/peaceful,tag=!blue.tr.coast,dx=0,sort=nearest,limit=1] positioned ~0.5 ~0.5 ~0.5 run function blue:tr/effects/coast/fire/proj/salmon_hit
