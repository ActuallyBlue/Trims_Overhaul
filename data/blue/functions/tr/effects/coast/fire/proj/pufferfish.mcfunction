...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[type=!#blue:tr/peaceful,tag=!blue.tr.coast,dx=0,sort=nearest,limit=1] positioned ~0.5 ~0.5 ~0.5 run function blue:tr/effects/coast/fire/proj/pufferfish_hit
