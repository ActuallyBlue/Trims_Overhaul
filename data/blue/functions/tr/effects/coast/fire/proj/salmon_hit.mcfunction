...
schedule function blue:tr/effects/coast/fire/proj/salmon_cooldown 1t replace
scoreboard players set @s blue.tr.salmon_cooldown 3
scoreboard players set #.temp blue.misc -99
particle rain ^ ^ ^-0.25 0.1 0.1 0.1 0 18
playsound entity.salmon.hurt player @a
tag @s add blue.tr.salmon_cooldown