...
execute unless score #.temp blue.misc matches -5521 run tag @s add blue.tr.snout.checked
...
execute if score #.temp blue.misc >= #.snout.gamble_limit blue.config unless score #.snout.gamble_limit blue.config matches -1 run tag @s add blue.tr.snout.checked
