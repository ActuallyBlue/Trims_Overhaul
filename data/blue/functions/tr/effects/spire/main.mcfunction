...
execute as @e[type=item,tag=!blue.tr.checked,distance=..6,nbt={Item:{id:"minecraft:dragon_breath",Count:1b}},limit=1] run function blue:tr/effects/spire/emp/throw
