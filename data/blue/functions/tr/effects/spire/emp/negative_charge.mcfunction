...
execute unless score #.reversal_charge blue.misc matches ..-600 run return 0
...
execute if block ~ ~-1 ~ #replaceable run return 0
...
summon area_effect_cloud ~ ~ ~ {Rotation:[0,180],Tags:["blue.tr.plunge_aec"],Particle:"witch",Duration:30,Radius:3,RadiusPerTick:0.5}
