scoreboard players operation #.temp blue.misc = #.reversal_charge blue.misc
execute if score #.temp blue.misc matches ..24 run scoreboard players reset #.reversal_charge blue.misc
...
execute if score #.reversal_charge blue.misc matches ..39 as @e[type=!#blue:shared/no_ai,distance=0.01..2] run data modify entity @s Motion[1] set value 1.0d
...
execute if score #.reversal_charge blue.misc matches 40..54 as @e[type=!#blue:shared/no_ai,distance=0.01..3.5] run data modify entity @s Motion[1] set value 1.5d
...
execute if score #.reversal_charge blue.misc matches 55..69 as @e[type=!#blue:shared/no_ai,distance=0.01..6.5] run data modify entity @s Motion[1] set value 2.0d
...
execute if score #.reversal_charge blue.misc matches 70.. as @e[type=!#blue:shared/no_ai,distance=0.01..9.5] run data modify entity @s Motion[1] set value 2.5d
