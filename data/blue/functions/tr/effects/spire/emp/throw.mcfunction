...
execute on origin anchored eyes run summon item ^ ^ ^2 {UUID:[I;-1318907857,14,0,1],Age:5700s,PickupDelay:32767s,Item:{id:"minecraft:dragon_breath",Count:1b},Tags:["blue.tr.checked","blue.tr.blast-o-breath"],Motion:[0d,0d,0d]}
