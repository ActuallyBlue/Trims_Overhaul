...
summon area_effect_cloud ~ ~ ~ {Rotation:[0,180],Tags:["blue.tr.blast-o-breath"],"Potion":"harming",Particle:"block air",Duration:15,Radius:0.5,RadiusPerTick:0.15,ReapplicationDelay:0}
