...
summon area_effect_cloud ~ ~ ~ {Tags:["blue.tr.blast-o-breath"],"Potion":"harming",Particle:"block air",Duration:15,Radius:0.5,RadiusPerTick:0.15}
summon area_effect_cloud ~ ~ ~ {Particle:"dragon_breath",Duration:15,Radius:1.5,RadiusPerTick:0.1}
