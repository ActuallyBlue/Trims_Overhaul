...
execute store success score #.temp blue.misc unless entity @s[predicate=!blue:shared/in_old_growth,tag=!blue.tr.dragon_egg]
execute if score #.temp blue.misc matches 1 run effect give @s resistance 1 9 true
