...
execute if entity @a[distance=..0.01,predicate=blue:shared/is_sneaking,limit=1] at @s as b163102f-0-0-0-100000000 if predicate blue:tr/undermine if block ~ ~-1 ~ #blue:trims/undermine run fill ~ ~-1 ~ ~ ~-1 ~ air destroy