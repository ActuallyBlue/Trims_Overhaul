...
execute if block ~ ~ ~ #blue:shared/passable summon tnt run data modify entity @s {} merge from storage blue:data trims.merge.tnt
execute if block ~ ~ ~ #blue:shared/passable summon tnt run data modify entity @s {} merge from storage blue:data trims.merge.tnt
execute unless block ~ ~ ~ #blue:shared/passable align xyz positioned ~0.5 ~0.5 ~0.5 summon tnt run data modify entity @s {} merge from storage blue:data trims.merge.tnt
execute unless block ~ ~ ~ #blue:shared/passable align xyz positioned ~0.5 ~0.5 ~0.5 summon tnt run data modify entity @s {} merge from storage blue:data trims.merge.tnt
