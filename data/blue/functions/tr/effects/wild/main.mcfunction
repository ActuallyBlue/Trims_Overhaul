...
execute if predicate blue:shared/is_sneaking align xyz positioned ~0.5 ~ ~0.5 if block ~ ~-1 ~ grass_block unless score #.wild.trap_cooldown blue.misc matches 1 run function blue:tr/effects/wild/emp/trap/placing
