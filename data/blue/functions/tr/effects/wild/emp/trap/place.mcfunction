...
execute positioned ~ ~-1.25 ~ align xyz if entity @e[tag=blue.tr.wild.trap,dx=0,limit=1,type=marker] run function blue:tr/effects/wild/emp/no_place
execute positioned ~ ~-1.25 ~ align xyz if entity @e[tag=blue.tr.wild.trap,dx=0,limit=1,type=marker] run return 0
