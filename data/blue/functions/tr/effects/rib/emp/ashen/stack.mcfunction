...
execute if score #.rib.ashen_cooldown blue.misc matches 1 run title @s actionbar {"text":"☠☠☠☠☠☠☠☠☠☠","color":"dark_gray","italic":true,"strikethrough":true}
execute if score #.rib.ashen_cooldown blue.misc matches 1 run return 0
...
execute unless score #.rib.ashen_stacks blue.misc matches 10.. run return 0
