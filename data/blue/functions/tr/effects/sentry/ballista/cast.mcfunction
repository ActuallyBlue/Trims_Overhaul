...
execute unless block ~ ~ ~ #blue:shared/passable run function blue:tr/effects/sentry/ballista/collide
execute unless score #.sentry.range blue.misc matches 0 unless block ^ ^ ^0.375 #blue:shared/passable run function blue:tr/effects/sentry/ballista/collide
...
execute if entity @s[distance=..9] run particle dust 1 0 0 0.5
