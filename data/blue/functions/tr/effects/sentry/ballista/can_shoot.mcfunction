...
execute if score #.sentry.range blue.misc matches 120 if predicate blue:tr/hero_1 run scoreboard players set #.sentry.range blue.misc 145
execute if score #.sentry.range blue.misc matches 120 if predicate blue:tr/hero_2 run scoreboard players set #.sentry.range blue.misc 170
execute if score #.sentry.range blue.misc matches 120 if predicate blue:tr/hero_3 run scoreboard players set #.sentry.range blue.misc 195
execute if score #.sentry.range blue.misc matches 120 if predicate blue:tr/hero_4 run scoreboard players set #.sentry.range blue.misc 215
