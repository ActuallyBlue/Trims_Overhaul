...
execute if score #.wayfinder_stored blue.misc matches 1.. if entity @s[tag=blue.tr.wayfinder] run function blue:tr/delayed/trims/wayfinder
execute if score #.silence_stored blue.misc matches 1.. if entity @s[tag=blue.tr.silence] run function blue:tr/delayed/trims/silence
execute if score #.shaper_stored blue.misc matches 1.. if entity @s[tag=blue.tr.shaper] run function blue:tr/delayed/trims/shaper
execute if score #.raiser_stored blue.misc matches 1.. if entity @s[tag=blue.tr.raiser] run function blue:tr/delayed/trims/raiser
execute if score #.sentry_stored blue.misc matches 1.. if entity @s[tag=blue.tr.sentry] run function blue:tr/delayed/trims/sentry
execute if score #.spire_stored blue.misc matches 1.. if entity @s[tag=blue.tr.spire] run function blue:tr/delayed/trims/spire
execute if score #.coast_stored blue.misc matches 1.. if entity @s[tag=blue.tr.coast] run function blue:tr/delayed/trims/coast
execute if score #.snout_stored blue.misc matches 1.. if entity @s[tag=blue.tr.snout] run function blue:tr/delayed/trims/snout
execute if score #.ward_stored blue.misc matches 1.. if entity @s[tag=blue.tr.ward] run function blue:tr/delayed/trims/ward
execute if score #.dune_stored blue.misc matches 1.. if entity @s[tag=blue.tr.dune] run function blue:tr/delayed/trims/dune
execute if score #.wild_stored blue.misc matches 1.. if entity @s[tag=blue.tr.wild] run function blue:tr/delayed/trims/wild
execute if score #.tide_stored blue.misc matches 1.. if entity @s[tag=blue.tr.tide] run function blue:tr/delayed/trims/tide
execute if score #.host_stored blue.misc matches 1.. if entity @s[tag=blue.tr.host] run function blue:tr/delayed/trims/host
execute if score #.eye_stored blue.misc matches 1.. if entity @s[tag=blue.tr.eye] run function blue:tr/delayed/trims/eye
execute if score #.rib_stored blue.misc matches 1.. if entity @s[tag=blue.tr.rib] run function blue:tr/delayed/trims/rib
execute if score #.vex_stored blue.misc matches 1.. if entity @s[tag=blue.tr.vex] run function blue:tr/delayed/trims/vex
