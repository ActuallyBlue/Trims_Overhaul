...
execute unless data storage blue:data trims.logs.unlock run tellraw @s [{"text":"- ","color":"dark_gray"},{"translate":"blue.tr.logs.empty","fallback":"Nothing has been stored in this type of log yet","color":"gray"}]
execute unless data storage blue:data trims.logs.unlock run return 0
