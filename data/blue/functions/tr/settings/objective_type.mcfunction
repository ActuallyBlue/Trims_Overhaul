...
execute if score #.tr.objective_type blue.config matches 0 run tellraw @s [{"translate":"blue.tr.objective_type","fallback":"Objective Type","hoverEvent":{"action":"show_text","contents":[{"translate":"blue.tr.objective_type_hover","fallback":"How players complete objectives (Quests, Tasks, Unlock, Impossible)","color":"gray"},{"translate":"blue.tr.objective_description","fallback":"\n Quests are multi-step and ideally difficult actions/goals\n Tasks are very repetitive and equally easy, but guarded by RTD\n Unlock simply requires players to be the first to pickup its template","color":"dark_gray"}]},"clickEvent":{"action":"run_command","value":"/function blue:tr/settings/objective_type"},"color":"gray"},{"text":": ","color":"dark_gray"},{"translate":"blue.tr.impossible","fallback":"Impossible","color":"dark_gray"}]
execute if score #.tr.objective_type blue.config matches 3 run tellraw @s [{"translate":"blue.tr.objective_type","fallback":"Objective Type","hoverEvent":{"action":"show_text","contents":[{"translate":"blue.tr.objective_type_hover","fallback":"How players complete objectives (Quests, Tasks, Unlock, Impossible)","color":"gray"},{"translate":"blue.tr.objective_description","fallback":"\n Quests are multi-step and ideally difficult actions/goals\n Tasks are very repetitive and equally easy, but guarded by RTD\n Unlock simply requires players to be the first to pickup its template","color":"dark_gray"}]},"clickEvent":{"action":"run_command","value":"/function blue:tr/settings/objective_type"},"color":"gray"},{"text":": ","color":"dark_gray"},{"translate":"blue.tr.unlock","fallback":"Unlock","color":"white"}]
execute if score #.tr.objective_type blue.config matches 2 run tellraw @s [{"translate":"blue.tr.objective_type","fallback":"Objective Type","hoverEvent":{"action":"show_text","contents":[{"translate":"blue.tr.objective_type_hover","fallback":"How players complete objectives (Quests, Tasks, Unlock, Impossible)","color":"gray"},{"translate":"blue.tr.objective_description","fallback":"\n Quests are multi-step and ideally difficult actions/goals\n Tasks are very repetitive and equally easy, but guarded by RTD\n Unlock simply requires players to be the first to pickup its template","color":"dark_gray"}]},"clickEvent":{"action":"run_command","value":"/function blue:tr/settings/objective_type"},"color":"gray"},{"text":": ","color":"dark_gray"},{"translate":"blue.tr.tasks","fallback":"Tasks","color":"dark_green"}]
execute if score #.tr.objective_type blue.config matches 1 run tellraw @s [{"translate":"blue.tr.objective_type","fallback":"Objective Type","hoverEvent":{"action":"show_text","contents":[{"translate":"blue.tr.objective_type_hover","fallback":"How players complete objectives (Quests, Tasks, Unlock, Impossible)","color":"gray"},{"translate":"blue.tr.objective_description","fallback":"\n Quests are multi-step and ideally difficult actions/goals\n Tasks are very repetitive and equally easy, but guarded by RTD\n Unlock simply requires players to be the first to pickup its template","color":"dark_gray"}]},"clickEvent":{"action":"run_command","value":"/function blue:tr/settings/objective_type"},"color":"gray"},{"text":": ","color":"dark_gray"},{"translate":"blue.tr.quests","fallback":"Quests","color":"dark_green"}]
execute unless score #.tr.objective_type blue.config matches 2 run return 0
