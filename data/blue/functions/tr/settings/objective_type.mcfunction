...
execute if score #.tr.objective_type blue.config matches 0 run tellraw @s [{"translate":"blue.tr.objective_type","fallback":"Objective Type","hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.objective_type_hover","fallback":"How players complete objectives (Quests, Tasks, Unlock, Impossible)","color":"gray"}},"clickEvent":{"action":"run_command","value":"/function blue:tr/settings/objective_type"},"color":"gray"},{"text":": ","color":"dark_gray"},{"translate":"blue.tr.impossible","fallback":"Impossible","color":"dark_gray"}]
