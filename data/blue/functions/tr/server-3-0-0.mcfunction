...
data modify storage blue:data trims.wayfinder.text set from storage blue:data trims.macro.owner.wayfinder
data modify storage blue:data trims.wayfinder.color set from storage blue:data trims.macro.owner.wayfinderC
data modify storage blue:data trims.silence.text set from storage blue:data trims.macro.owner.silence
data modify storage blue:data trims.silence.color set from storage blue:data trims.macro.owner.silenceC
data modify storage blue:data trims.shaper.text set from storage blue:data trims.macro.owner.shaper
data modify storage blue:data trims.shaper.color set from storage blue:data trims.macro.owner.shaperC
data modify storage blue:data trims.raiser.text set from storage blue:data trims.macro.owner.raiser
data modify storage blue:data trims.raiser.color set from storage blue:data trims.macro.owner.raiserC
data modify storage blue:data trims.sentry.text set from storage blue:data trims.macro.owner.sentry
data modify storage blue:data trims.sentry.color set from storage blue:data trims.macro.owner.sentryC
data modify storage blue:data trims.spire.text set from storage blue:data trims.macro.owner.spire
data modify storage blue:data trims.spire.color set from storage blue:data trims.macro.owner.spireC
data modify storage blue:data trims.coast.text set from storage blue:data trims.macro.owner.coast
data modify storage blue:data trims.coast.color set from storage blue:data trims.macro.owner.coastC
data modify storage blue:data trims.snout.text set from storage blue:data trims.macro.owner.snout
data modify storage blue:data trims.snout.color set from storage blue:data trims.macro.owner.snoutC
data modify storage blue:data trims.ward.text set from storage blue:data trims.macro.owner.ward
data modify storage blue:data trims.ward.color set from storage blue:data trims.macro.owner.wardC
data modify storage blue:data trims.dune.text set from storage blue:data trims.macro.owner.dune
data modify storage blue:data trims.dune.color set from storage blue:data trims.macro.owner.duneC
data modify storage blue:data trims.wild.text set from storage blue:data trims.macro.owner.wild
data modify storage blue:data trims.wild.color set from storage blue:data trims.macro.owner.wildC
data modify storage blue:data trims.tide.text set from storage blue:data trims.macro.owner.tide
data modify storage blue:data trims.tide.color set from storage blue:data trims.macro.owner.tideC
data modify storage blue:data trims.host.text set from storage blue:data trims.macro.owner.host
data modify storage blue:data trims.host.color set from storage blue:data trims.macro.owner.hostC
data modify storage blue:data trims.eye.text set from storage blue:data trims.macro.owner.eye
data modify storage blue:data trims.eye.color set from storage blue:data trims.macro.owner.eyeC
data modify storage blue:data trims.rib.text set from storage blue:data trims.macro.owner.rib
data modify storage blue:data trims.rib.color set from storage blue:data trims.macro.owner.ribC
data modify storage blue:data trims.vex.text set from storage blue:data trims.macro.owner.vex
data modify storage blue:data trims.vex.color set from storage blue:data trims.macro.owner.vexC
