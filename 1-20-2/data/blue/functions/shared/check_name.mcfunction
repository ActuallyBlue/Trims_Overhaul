...
$execute if data storage blue:shared players[{UUID:$(uuid)}].name run data modify storage blue:shared players[{UUID:$(uuid)}].name set from storage blue:shared player_name
$execute if data storage blue:shared players[{UUID:$(uuid)}].name run return 0
