$execute if data storage blue:data shared.names[{uuid:$(UUID)}].name run function #blue:name_changed with storage blue:data shared.names[{uuid:$(UUID)}]
$execute if data storage blue:data shared.names[{uuid:$(UUID)}].name run return 0
