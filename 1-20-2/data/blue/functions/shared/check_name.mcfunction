...
$execute if data storage blue:data shared.players[{UUID:$(uuid)}].name run data modify storage blue:data shared.players[{UUID:$(uuid)}].name set from storage blue:data player_name
$execute if data storage blue:data shared.players[{UUID:$(uuid)}].name run return 0
