...
execute unless score #.temp blue.misc matches 15..34 run tellraw @p[gamemode=creative,distance=..9] {"storage":"blue:trims","nbt":"display[][]","interpret":true,"separator":""}
