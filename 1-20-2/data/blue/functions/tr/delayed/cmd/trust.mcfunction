...
execute unless score @s Trims_Menu.BLUE matches 1000 run return 0
...
execute if score @s blue.tr.current_trim matches 4 unless score #.players blue.misc >= #.tr.trust_compact blue.config run tellraw @s [{"text":"-- -- -- -- -- -- -- ","color":"gray"},{"text":"ℹ","hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.host_untrust","fallback":"Hitting allied players enough times will remove Host's trust from all nearby players","color":"gray"}}}," -- -- -- -- -- -- --\n",{"storage":"blue:trims","nbt":"display[][]","separator":"\n","interpret":true},"\n-- -- -- -- -- -- -- -- -- -- -- -- -- --"]
execute if score @s blue.tr.current_trim matches 4 if score #.players blue.misc >= #.tr.trust_compact blue.config run tellraw @s [{"text":"-- -- -- -- -- -- -- ","color":"gray"},{"text":"ℹ","hoverEvent":{"action":"show_text","contents":{"translate":"blue.tr.host_untrust","fallback":"Hitting allied players enough times will remove Host's trust from all nearby players","color":"gray"}}}," -- -- -- -- -- -- --\n",{"storage":"blue:trims","nbt":"display[][]","separator":{"text":", ","color":"gray"},"interpret":true},"\n-- -- -- -- -- -- -- -- -- -- -- -- -- --"]
execute unless score @s blue.tr.current_trim matches 4 unless score #.players blue.misc >= #.tr.trust_compact blue.config run tellraw @s [{"text":"-- -- -- -- -- -- -- -- -- -- -- -- -- --\n","color":"gray"},{"storage":"blue:trims","nbt":"display[][]","separator":"\n","interpret":true},"\n-- -- -- -- -- -- -- -- -- -- -- -- -- --"]
execute unless score @s blue.tr.current_trim matches 4 if score #.players blue.misc >= #.tr.trust_compact blue.config run tellraw @s [{"text":"-- -- -- -- -- -- -- -- -- -- -- -- -- --\n","color":"gray"},{"storage":"blue:trims","nbt":"display[][]","separator":{"text":", ","color":"gray"},"interpret":true},"\n-- -- -- -- -- -- -- -- -- -- -- -- -- --"]