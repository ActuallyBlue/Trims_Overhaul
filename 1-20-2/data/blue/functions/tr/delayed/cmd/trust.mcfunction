...
function blue:tr/delayed/cmd/trust/translate with storage blue:data trims.temp
execute unless score @s Trims_Menu.BLUE matches 1000 store result storage blue:data trims.temp.click int 1 run scoreboard players get @s Trims_Menu.BLUE
...
execute unless score @s Trims_Menu.BLUE matches 1000 as @a[predicate=blue:shared/id_link,limit=1] run function blue:tr/delayed/cmd/trust/change with storage blue:data trims.temp
...
function blue:tr/delayed/cmd/trust/pre with storage blue:data trims.temp
