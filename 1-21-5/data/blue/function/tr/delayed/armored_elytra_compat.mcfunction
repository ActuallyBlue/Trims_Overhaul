...
data modify storage blue:trims temp.elytra set from entity b163102f-0-0-0-100000000 equipment.mainhand
...
data modify entity b163102f-0-0-0-100000000 equipment.mainhand set from storage blue:trims temp.elytra
