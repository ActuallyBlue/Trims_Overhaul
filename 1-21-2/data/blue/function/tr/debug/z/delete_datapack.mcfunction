...
execute as @a run attribute @s block_interaction_range modifier remove blue:tr.trim
execute as @a run attribute @s submerged_mining_speed modifier remove blue:tr.trim
execute as @a run attribute @s mining_efficiency modifier remove blue:tr.trim
execute as @a run attribute @s step_height modifier remove blue:tr.trim
execute as @a run attribute @s safe_fall_distance modifier remove blue:tr.trim
execute as @a run attribute @s attack_knockback modifier remove blue:tr.trim
execute as @a run attribute @s gravity modifier remove blue:tr.trim
execute as @a run attribute @s knockback_resistance modifier remove blue:tr.head
execute as @a run attribute @s armor_toughness modifier remove blue:tr.head
execute as @a run attribute @s movement_speed modifier remove blue:tr.head
execute as @a run attribute @s attack_damage modifier remove blue:tr.head
execute as @a run attribute @s attack_speed modifier remove blue:tr.head
execute as @a run attribute @s max_health modifier remove blue:tr.head
execute as @a run attribute @s armor modifier remove blue:tr.head
execute as @a run attribute @s luck modifier remove blue:tr.head
execute as @a run attribute @s knockback_resistance modifier remove blue:tr.chest
execute as @a run attribute @s armor_toughness modifier remove blue:tr.chest
execute as @a run attribute @s movement_speed modifier remove blue:tr.chest
execute as @a run attribute @s attack_damage modifier remove blue:tr.chest
execute as @a run attribute @s attack_speed modifier remove blue:tr.chest
execute as @a run attribute @s max_health modifier remove blue:tr.chest
execute as @a run attribute @s armor modifier remove blue:tr.chest
execute as @a run attribute @s luck modifier remove blue:tr.chest
execute as @a run attribute @s knockback_resistance modifier remove blue:tr.legs
execute as @a run attribute @s armor_toughness modifier remove blue:tr.legs
execute as @a run attribute @s movement_speed modifier remove blue:tr.legs
execute as @a run attribute @s attack_damage modifier remove blue:tr.legs
execute as @a run attribute @s attack_speed modifier remove blue:tr.legs
execute as @a run attribute @s max_health modifier remove blue:tr.legs
execute as @a run attribute @s armor modifier remove blue:tr.legs
execute as @a run attribute @s luck modifier remove blue:tr.legs
execute as @a run attribute @s knockback_resistance modifier remove blue:tr.boots
execute as @a run attribute @s armor_toughness modifier remove blue:tr.boots
execute as @a run attribute @s movement_speed modifier remove blue:tr.boots
execute as @a run attribute @s attack_damage modifier remove blue:tr.boots
execute as @a run attribute @s attack_speed modifier remove blue:tr.boots
execute as @a run attribute @s max_health modifier remove blue:tr.boots
execute as @a run attribute @s armor modifier remove blue:tr.boots
execute as @a run attribute @s luck modifier remove blue:tr.boots
execute as @a run attribute @s knockback_resistance modifier remove blue:tr.set
execute as @a run attribute @s armor_toughness modifier remove blue:tr.set
execute as @a run attribute @s movement_speed modifier remove blue:tr.set
execute as @a run attribute @s attack_damage modifier remove blue:tr.set
execute as @a run attribute @s attack_speed modifier remove blue:tr.set
execute as @a run attribute @s max_health modifier remove blue:tr.set
execute as @a run attribute @s armor modifier remove blue:tr.set
execute as @a run attribute @s luck modifier remove blue:tr.set
execute as @a run attribute @s max_health modifier remove blue:tr.trim
