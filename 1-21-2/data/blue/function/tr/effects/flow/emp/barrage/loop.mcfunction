...
execute if score #.flow.barrage_time blue.misc matches 2 run attribute @s gravity modifier remove blue:tr.trim
execute if score #.flow.barrage_time blue.misc matches 2 run attribute @s gravity modifier add blue:tr.trim -0.0625 add_value
execute if score #.flow.barrage_time blue.misc matches 11..43 run particle cloud ~ ~0.25 ~ 0.2 0 0.2 0 1
execute if score #.flow.barrage_time blue.misc matches 39 run attribute @s gravity modifier remove blue:tr.trim
execute if score #.flow.barrage_time blue.misc matches 39 run attribute @s gravity modifier add blue:tr.trim -0.08 add_value
...
execute if score #.flow.barrage_time blue.misc matches 62.. if predicate blue:shared/is_sneaking run tp ~ ~-0.2 ~
execute if score #.flow.barrage_time blue.misc matches 62.. if predicate {"condition":"entity_properties","entity":"this","predicate":{"type_specific":{"type":"player","input":{"jump":true}}}} at @s run tp ~ ~0.15 ~
