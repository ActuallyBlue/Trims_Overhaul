...
execute if score #.temp blue.misc matches 0 if entity @s[x_rotation=-90..-12,predicate=!blue:shared/is_sneaking] run return run attribute @s gravity modifier add blue:tr.trim -0.05 add_value
execute if score #.temp blue.misc matches 1 if entity @s[x_rotation=-90..-12,predicate=!blue:shared/is_sneaking] run return run attribute @s gravity modifier add blue:tr.trim -0.06 add_value
...
execute if score #.temp blue.misc matches 1 run return run attribute @s gravity modifier add blue:tr.trim -0.04 add_value
