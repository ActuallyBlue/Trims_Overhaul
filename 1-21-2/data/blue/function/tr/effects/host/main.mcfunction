...
execute if score #.temp blue.misc matches 160.. store success score #.temp blue.misc run attribute @s[advancements={blue:tr/cure={7=true}}] max_health modifier add blue:tr.trim 14 add_value
execute if score #.temp blue.misc matches 140.. store success score #.temp blue.misc run attribute @s[advancements={blue:tr/cure={6=true}}] max_health modifier add blue:tr.trim 12 add_value
