...
attribute @s step_height modifier remove blue.tr.bolt_perm
attribute @s fall_damage_multiplier modifier remove blue.tr.flow_perm
attribute @s attack_knockback modifier remove blue.tr.flow_perm
attribute @s gravity modifier remove blue.tr.flow_perm
attribute @s gravity modifier remove blue.tr.flow
attribute @s max_health modifier remove blue.tr.host
