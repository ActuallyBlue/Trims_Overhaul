...
attribute @s water_movement_efficiency modifier remove blue:tr.chest
attribute @s movement_efficiency modifier remove blue:tr.chest
attribute @s sneaking_speed modifier remove blue:tr.chest
