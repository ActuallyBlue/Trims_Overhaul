...
attribute @s water_movement_efficiency modifier remove blue:tr.feet
attribute @s movement_efficiency modifier remove blue:tr.feet
attribute @s sneaking_speed modifier remove blue:tr.feet
