...
execute if data storage blue:trims armor.legs{material:"minecraft:redstone"} run return run attribute @s max_health modifier add blue:tr.legs 1.0 add_value
...
execute if data storage blue:trims armor.legs{material:"minecraft:lapis"} run return run attribute @s movement_speed modifier add blue:tr.legs 0.003 add_value
...
execute if data storage blue:trims armor.legs{material:"minecraft:gold"} run return run attribute @s attack_speed modifier add blue:tr.legs 0.04 add_value
