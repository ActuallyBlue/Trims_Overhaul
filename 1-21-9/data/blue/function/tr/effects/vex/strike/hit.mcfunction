execute positioned ^ ^ ^3 as @e[type=!#blue:shared/peaceful,distance=..4] unless entity b163102f-0-8-0-1 at @s on attacker if entity @s[tag=blue.tr.vex] run summon area_effect_cloud ~ ~ ~ {Rotation:[0,180],Radius:0,Duration:1,UUID:[I;-1318907857,8,0,1],custom_particle:{type:"minecraft:block",block_state:"minecraft:air"}}
