...
execute if score @s blue.misc matches ..4 run return fail
effect give @e[type=!#blue:shared/no_effects,tag=!blue.tr.silence,distance=..7.5] slow_falling 1 0
execute as @e[type=!#blue:shared/no_effects,type=!player,tag=!smithed.strict,distance=..8] at @s facing entity b163102f-0-6-0-1 eyes positioned ^ ^ ^0.5 if block ~ ~ ~ #blue:shared/passable run tp @s ^ ^ ^-0.42
...
execute as @e[type=!#blue:shared/no_effects,tag=!blue.tr.silence,distance=..1.5] run damage @s 90 blue:tr/vortex by b163102f-0-6-0-1 from @a[tag=blue.tr.silence,limit=1]
execute as @e[type=!#blue:shared/no_effects,tag=!blue.tr.silence,distance=1.51..2] run damage @s 81 blue:tr/vortex by b163102f-0-6-0-1 from @a[tag=blue.tr.silence,limit=1]
execute as @e[type=!#blue:shared/no_effects,tag=!blue.tr.silence,distance=2.51..3] run damage @s 72 blue:tr/vortex by b163102f-0-6-0-1 from @a[tag=blue.tr.silence,limit=1]
execute as @e[type=!#blue:shared/no_effects,tag=!blue.tr.silence,distance=3.51..4] run damage @s 63 blue:tr/vortex by b163102f-0-6-0-1 from @a[tag=blue.tr.silence,limit=1]
execute as @e[type=!#blue:shared/no_effects,tag=!blue.tr.silence,distance=4.51..5] run damage @s 54 blue:tr/vortex by b163102f-0-6-0-1 from @a[tag=blue.tr.silence,limit=1]
execute as @e[type=!#blue:shared/no_effects,tag=!blue.tr.silence,distance=5.51..6] run damage @s 45 blue:tr/vortex by b163102f-0-6-0-1 from @a[tag=blue.tr.silence,limit=1]
execute as @e[type=!#blue:shared/no_effects,tag=!blue.tr.silence,distance=6.51..7] run damage @s 36 blue:tr/vortex by b163102f-0-6-0-1 from @a[tag=blue.tr.silence,limit=1]
execute as @e[type=!#blue:shared/no_effects,tag=!blue.tr.silence,distance=7.51..9] run damage @s 27 blue:tr/vortex by b163102f-0-6-0-1 from @a[tag=blue.tr.silence,limit=1]
execute unless score #.silence.vortex_griefing blue.config matches 1 run return run kill
