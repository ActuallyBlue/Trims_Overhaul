...
particle flash{color:[1,1,1,0.5]} ~ ~1 ~ 0.2 0.2 0.2 0 3 force @s[scores={blue.particles=1..}]
particle flash{color:[1,1,1,0.5]} ~ ~1 ~ 0.2 0.2 0.2 0 3 force @s[scores={blue.particles=2..}]
